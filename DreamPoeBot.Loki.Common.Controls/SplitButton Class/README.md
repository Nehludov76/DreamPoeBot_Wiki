...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Common.Controls.SplitButton"]
...
```csharp
public ref class SplitButton : public Button
```
...
|  | OnClick | (Overrides Button OnClick .) |
...
|  | OnKeyDown | (Overrides ButtonBase OnKeyDown(KeyEventArgs) .) |
...
## Дочерние разделы
- [**SplitButton Constructor **](./SplitButton Constructor/README.md)
- [**SplitButton Properties**](./SplitButton Properties/README.md)
- [**SplitButton Methods**](./SplitButton Methods/README.md)
- [**SplitButton Events**](./SplitButton Events/README.md)
