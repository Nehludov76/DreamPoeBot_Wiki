...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Common.Controls.MenuButton"]
...
```csharp
public ref class MenuButton : public SplitButton
```
...
The MenuButton type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MenuButton | Initializes a new instance of the MenuButton class |
...
|  | ButtonMenuItemsSource | (Inherited from SplitButton .) |
|  | CacheMode | Gets or sets a cached representation of the UIElement . (Inherited from UIElement .) |
|  | ClickMode | Gets or sets when the Click event occurs. (Inherited from ButtonBase .) |
...
|  | CommandTarget | Gets or sets the element on which to raise the specified command. (Inherited from ButtonBase .) |
...
|  | IsCancel | Gets or sets a value that indicates whether a Button is a Cancel button. A user can activate the Cancel button by pressing the ESC key. (Inherited from Button .) |
|  | IsDefault | Gets or sets a value that indicates whether a Button is the default button. A user invokes the default button by pressing the ENTER key. (Inherited from Button .) |
|  | IsDefaulted | Gets a value that indicates whether a Button is the button that is activated when a user presses ENTER. (Inherited from Button .) |
...
|  | IsEnabledCore | Gets the value of the IsEnabled property. (Inherited from ButtonBase .) |
...
|  | IsPressed | Gets a value that indicates whether a ButtonBase is currently activated. (Inherited from ButtonBase .) |
...
|  | LogicalChildren | Gets an enumerator to the content control's logical child elements. (Inherited from ContentControl .) |
...
|  | OnAccessKey | Responds when the AccessKey for this control is called. (Inherited from ButtonBase .) |
|  | OnApplyTemplate | (Inherited from SplitButton .) |
|  | OnChildDesiredSizeChanged | Supports layout behavior when a child element is resized. (Inherited from UIElement .) |
|  | OnClick | (Overrides SplitButton OnClick .) |
...
|  | OnCreateAutomationPeer | Creates an appropriate ButtonAutomationPeer for this control as part of the WPF infrastructure. (Inherited from Button .) |
...
|  | OnIsPressedChanged | Called when the IsPressed property changes. (Inherited from ButtonBase .) |
...
|  | OnKeyDown | (Inherited from SplitButton .) |
|  | OnKeyUp | Provides class handling for the KeyUp routed event that occurs when the user releases a key while this control has focus. (Inherited from ButtonBase .) |
|  | OnLostFocus | Raises the LostFocus routed event by using the event data that is provided. (Inherited from UIElement .) |
|  | OnLostKeyboardFocus | Called when an element loses keyboard focus. (Inherited from ButtonBase .) |
|  | OnLostMouseCapture | Provides class handling for the LostMouseCapture routed event that occurs when this control is no longer receiving mouse event messages. (Inherited from ButtonBase .) |
...
|  | OnMouseEnter | Provides class handling for the ClickMode routed event that occurs when the mouse enters this control. (Inherited from ButtonBase .) |
|  | OnMouseLeave | Provides class handling for the MouseLeave routed event that occurs when the mouse leaves an element. (Inherited from ButtonBase .) |
|  | OnMouseLeftButtonDown | Provides class handling for the MouseLeftButtonDown routed event that occurs when the left mouse button is pressed while the mouse pointer is over this control. (Inherited from ButtonBase .) |
|  | OnMouseLeftButtonUp | Provides class handling for the MouseLeftButtonUp routed event that occurs when the left mouse button is released while the mouse pointer is over this control. (Inherited from ButtonBase .) |
|  | OnMouseMove | Provides class handling for the MouseMove routed event that occurs when the mouse pointer moves while over this element. (Inherited from ButtonBase .) |
...
|  | OnRenderSizeChanged | Called when the rendered size of a control changes. (Inherited from ButtonBase .) |
...
|  | OpenButtonMenu | (Inherited from SplitButton .) |
...
|  | Name | Description |
| --- | --- | --- |
|  | Click | Occurs when a Button is clicked. (Inherited from ButtonBase .) |
...
## Дочерние разделы
- [**MenuButton Constructor **](./MenuButton Constructor/README.md)
- [**MenuButton Properties**](./MenuButton Properties/README.md)
- [**MenuButton Methods**](./MenuButton Methods/README.md)
- [**MenuButton Events**](./MenuButton Events/README.md)
