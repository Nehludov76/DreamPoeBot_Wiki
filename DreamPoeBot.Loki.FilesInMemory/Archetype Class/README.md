...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.FilesInMemory.Archetype"]


```csharp
public class Archetype : FileInMemory
```
...
```csharp
public ref class Archetype : public FileInMemory
```
