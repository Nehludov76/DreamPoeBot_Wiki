...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.FilesInMemory.TagsDat"]
...
```csharp
public ref class TagsDat : public FileInMemory
```
...
| Name | Description |
| --- | --- |
| TagsDat | Initializes a new instance of the TagsDat class |
