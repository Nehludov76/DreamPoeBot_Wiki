...
```csharp
public class Gui : UserControl , IComponentConnector , IStyleConnector
```
...
```csharp
public ref class Gui : public UserControl , IComponentConnector , IStyleConnector
```
...
The Gui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | Gui | Initializes a new instance of the Gui class |
...
## Дочерние разделы
- [**Gui Constructor **](./Gui Constructor/README.md)
- [**Gui Properties**](./Gui Properties/README.md)
- [**Gui Methods**](./Gui Methods/README.md)
- [**Gui Events**](./Gui Events/README.md)
