...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SpecificElement.ComboBoxElement"]
...
```csharp
public ref class ComboBoxElement : public Element
```
...
The ComboBoxElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ComboBoxElement | Initializes a new instance of the ComboBoxElement class |
...
## Дочерние разделы
- [**ComboBoxElement Constructor **](./ComboBoxElement Constructor/README.md)
- [**ComboBoxElement Properties**](./ComboBoxElement Properties/README.md)
- [**ComboBoxElement Methods**](./ComboBoxElement Methods/README.md)
- [**ComboBoxElement Fields**](./ComboBoxElement Fields/README.md)
