...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.NotificationHudElement"]
...
```csharp
public ref class NotificationHudElement : public Element
```
...
The NotificationHudElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | NotificationHudElement | Initializes a new instance of the NotificationHudElement class |
...
## Дочерние разделы
- [**NotificationHudElement Constructor **](./NotificationHudElement Constructor/README.md)
- [**NotificationHudElement Properties**](./NotificationHudElement Properties/README.md)
- [**NotificationHudElement Methods**](./NotificationHudElement Methods/README.md)
- [**NotificationHudElement Fields**](./NotificationHudElement Fields/README.md)
