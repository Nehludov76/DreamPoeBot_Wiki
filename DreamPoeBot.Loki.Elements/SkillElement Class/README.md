...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SkillElement"]
...
```csharp
public ref class SkillElement : public Element
```
...
| Name | Description |
| --- | --- |
| SkillElement | Initializes a new instance of the SkillElement class |
