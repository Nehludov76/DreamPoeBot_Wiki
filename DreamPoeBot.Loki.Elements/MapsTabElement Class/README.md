...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapsTabElement"]
...
```csharp
public ref class MapsTabElement : public Element
```
...
The MapsTabElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MapsTabElement | Initializes a new instance of the MapsTabElement class |
...
## Дочерние разделы
- [**MapsTabElement Constructor **](./MapsTabElement Constructor/README.md)
- [**MapsTabElement Properties**](./MapsTabElement Properties/README.md)
- [**MapsTabElement Methods**](./MapsTabElement Methods/README.md)
- [**MapsTabElement Fields**](./MapsTabElement Fields/README.md)
