...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.CardTradeElement"]
...
```csharp
public ref class CardTradeElement : public Element
```
...
The CardTradeElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CardTradeElement | Initializes a new instance of the CardTradeElement class |
...
## Дочерние разделы
- [**CardTradeElement Constructor **](./CardTradeElement Constructor/README.md)
- [**CardTradeElement Properties**](./CardTradeElement Properties/README.md)
- [**CardTradeElement Methods**](./CardTradeElement Methods/README.md)
- [**CardTradeElement Fields**](./CardTradeElement Fields/README.md)
