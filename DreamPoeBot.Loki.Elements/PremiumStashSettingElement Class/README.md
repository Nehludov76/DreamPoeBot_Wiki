# PremiumStashSettingElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PremiumStashSettingElement"]
...
```csharp
public ref class PremiumStashSettingElement : public Element
```
...
The PremiumStashSettingElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PremiumStashSettingElement | Initializes a new instance of the PremiumStashSettingElement class |
...
## Дочерние разделы
- [**PremiumStashSettingElement Constructor **](./PremiumStashSettingElement Constructor/README.md)
- [**PremiumStashSettingElement Properties**](./PremiumStashSettingElement Properties/README.md)
- [**PremiumStashSettingElement Methods**](./PremiumStashSettingElement Methods/README.md)
- [**PremiumStashSettingElement Fields**](./PremiumStashSettingElement Fields/README.md)
