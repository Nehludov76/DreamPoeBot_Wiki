...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.LeagueSelectionElement"]
...
```csharp
public ref class LeagueSelectionElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | LeagueSelectionElement | Initializes a new instance of the LeagueSelectionElement class |
...
## Дочерние разделы
- [**LeagueSelectionElement Constructor **](./LeagueSelectionElement Constructor/README.md)
- [**LeagueSelectionElement Properties**](./LeagueSelectionElement Properties/README.md)
- [**LeagueSelectionElement Methods**](./LeagueSelectionElement Methods/README.md)
- [**LeagueSelectionElement Fields**](./LeagueSelectionElement Fields/README.md)
