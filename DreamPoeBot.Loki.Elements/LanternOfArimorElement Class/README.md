...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.LanternOfArimorElement"]


```csharp
public class LanternOfArimorElement : Element
```
...
```csharp
public ref class LanternOfArimorElement : public Element
```
...
The LanternOfArimorElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | LanternOfArimorElement | Initializes a new instance of the LanternOfArimorElement class |
...
|  | EmbersoftheAllflameButtonElement |  |
|  | EnterButtonElement |  |
|  | Game | (Inherited from RemoteMemoryObject .) |
|  | GeneralInventoryElement |  |
...
|  | MainInventoryElement |  |
|  | MainMonsterElement |  |
|  | MainUi |  |
|  | NecropolisLockerElement |  |
...
## Дочерние разделы
- [**LanternOfArimorElement Constructor **](./LanternOfArimorElement Constructor/README.md)
- [**LanternOfArimorElement Properties**](./LanternOfArimorElement Properties/README.md)
- [**LanternOfArimorElement Methods**](./LanternOfArimorElement Methods/README.md)
- [**LanternOfArimorElement Fields**](./LanternOfArimorElement Fields/README.md)
