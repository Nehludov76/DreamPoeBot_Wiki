# MapsTabElement.MapsInventory Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapsTabElement.MapsInventory"]


```csharp
public class MapsInventory : Element
```
...
```csharp
public ref class MapsInventory : public Element
```
...
The MapsTabElement MapsInventory type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MapsTabElement MapsInventory | Initializes a new instance of the MapsTabElement MapsInventory class |
...
## Дочерние разделы
- [**MapsTabElement.MapsInventory Constructor **](./MapsTabElement.MapsInventory Constructor/README.md)
- [**MapsInventory Properties**](./MapsInventory Properties/README.md)
- [**MapsInventory Methods**](./MapsInventory Methods/README.md)
- [**MapsInventory Fields**](./MapsInventory Fields/README.md)
