...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InstanceManager"]
...
```csharp
public ref class InstanceManager : public Element
```
...
The InstanceManager type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | InstanceManager | Initializes a new instance of the InstanceManager class |
...
## Дочерние разделы
- [**InstanceManager Constructor **](./InstanceManager Constructor/README.md)
- [**InstanceManager Properties**](./InstanceManager Properties/README.md)
- [**InstanceManager Methods**](./InstanceManager Methods/README.md)
- [**InstanceManager Fields**](./InstanceManager Fields/README.md)
