...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BloodCrucibleElement"]
...
```csharp
public ref class BloodCrucibleElement : public Element
```
...
The BloodCrucibleElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BloodCrucibleElement | Initializes a new instance of the BloodCrucibleElement class |
...
## Дочерние разделы
- [**BloodCrucibleElement Constructor **](./BloodCrucibleElement Constructor/README.md)
- [**BloodCrucibleElement Properties**](./BloodCrucibleElement Properties/README.md)
- [**BloodCrucibleElement Methods**](./BloodCrucibleElement Methods/README.md)
- [**BloodCrucibleElement Fields**](./BloodCrucibleElement Fields/README.md)
