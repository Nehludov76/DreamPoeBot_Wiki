# TradePriceItemDialogElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.TradePriceItemDialogElement"]


```csharp
public class TradePriceItemDialogElement : Element
```
...
```csharp
public ref class TradePriceItemDialogElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | TradePriceItemDialogElement | Initializes a new instance of the TradePriceItemDialogElement class |
...
## Дочерние разделы
- [**TradePriceItemDialogElement Constructor **](./TradePriceItemDialogElement Constructor/README.md)
- [**TradePriceItemDialogElement Properties**](./TradePriceItemDialogElement Properties/README.md)
- [**TradePriceItemDialogElement Methods**](./TradePriceItemDialogElement Methods/README.md)
- [**TradePriceItemDialogElement Fields**](./TradePriceItemDialogElement Fields/README.md)
