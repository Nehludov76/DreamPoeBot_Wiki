...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.WishesElement"]


```csharp
public class WishesElement : Element
```
...
```csharp
public ref class WishesElement : public Element
```
...
The WishesElement type exposes the following members.


| Name | Description |
| --- | --- |
| WishesElement | Initializes a new instance of the WishesElement class |
