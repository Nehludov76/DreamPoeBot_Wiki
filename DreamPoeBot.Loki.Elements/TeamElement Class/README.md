...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.TeamElement"]
...
```csharp
public ref class TeamElement : public Element
```
...
The TeamElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | TeamElement | Initializes a new instance of the TeamElement class |
...
## Дочерние разделы
- [**TeamElement Constructor **](./TeamElement Constructor/README.md)
- [**TeamElement Properties**](./TeamElement Properties/README.md)
- [**TeamElement Methods**](./TeamElement Methods/README.md)
- [**TeamElement Fields**](./TeamElement Fields/README.md)
