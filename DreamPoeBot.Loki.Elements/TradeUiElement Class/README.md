...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.TradeUiElement"]
...
```csharp
public ref class TradeUiElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | TradeUiElement | Initializes a new instance of the TradeUiElement class |
...
## Дочерние разделы
- [**TradeUiElement Constructor **](./TradeUiElement Constructor/README.md)
- [**TradeUiElement Properties**](./TradeUiElement Properties/README.md)
- [**TradeUiElement Methods**](./TradeUiElement Methods/README.md)
- [**TradeUiElement Fields**](./TradeUiElement Fields/README.md)
