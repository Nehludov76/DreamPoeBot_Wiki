# SanctumArchivesElement.SanctumRoom Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SanctumArchivesElement.SanctumRoom"]
...
```csharp
public ref class SanctumRoom : public Element
```
...
The SanctumArchivesElement SanctumRoom type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SanctumArchivesElement SanctumRoom | Initializes a new instance of the SanctumArchivesElement SanctumRoom class |
...
|  | PersistentEffectName |  |
|  | PersistentEffectStatType |  |
...
## Дочерние разделы
- [**SanctumArchivesElement.SanctumRoom Constructor **](./SanctumArchivesElement.SanctumRoom Constructor/README.md)
- [**SanctumRoom Properties**](./SanctumRoom Properties/README.md)
- [**SanctumRoom Methods**](./SanctumRoom Methods/README.md)
- [**SanctumRoom Fields**](./SanctumRoom Fields/README.md)
