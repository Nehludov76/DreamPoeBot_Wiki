...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.NecropolisCorpseElement"]


```csharp
public class NecropolisCorpseElement : Element
```
...
```csharp
public ref class NecropolisCorpseElement : public Element
```
...
The NecropolisCorpseElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | NecropolisCorpseElement | Initializes a new instance of the NecropolisCorpseElement class |
...
## Дочерние разделы
- [**NecropolisCorpseElement Constructor **](./NecropolisCorpseElement Constructor/README.md)
- [**NecropolisCorpseElement Properties**](./NecropolisCorpseElement Properties/README.md)
- [**NecropolisCorpseElement Methods**](./NecropolisCorpseElement Methods/README.md)
- [**NecropolisCorpseElement Fields**](./NecropolisCorpseElement Fields/README.md)
