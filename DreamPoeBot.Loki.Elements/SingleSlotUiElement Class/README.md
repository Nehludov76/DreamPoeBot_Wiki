...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SingleSlotUiElement"]
...
```csharp
public ref class SingleSlotUiElement : public Element
```
...
The SingleSlotUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SingleSlotUiElement | Initializes a new instance of the SingleSlotUiElement class |
|  | SingleSlotUiElement(Int64, SingleSlotUiElement SingleSlotType) | Initializes a new instance of the SingleSlotUiElement class |
|  | SingleSlotUiElement(Element, SingleSlotUiElement SingleSlotType) | Initializes a new instance of the SingleSlotUiElement class |
...
## Дочерние разделы
- [**SingleSlotUiElement Constructor **](./SingleSlotUiElement Constructor/README.md)
- [**SingleSlotUiElement Properties**](./SingleSlotUiElement Properties/README.md)
- [**SingleSlotUiElement Methods**](./SingleSlotUiElement Methods/README.md)
- [**SingleSlotUiElement Fields**](./SingleSlotUiElement Fields/README.md)
