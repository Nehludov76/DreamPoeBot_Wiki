...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AgentElement"]
...
```csharp
public ref class AgentElement : public Element
```
...
The AgentElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AgentElement | Initializes a new instance of the AgentElement class |
...
## Дочерние разделы
- [**AgentElement Constructor **](./AgentElement Constructor/README.md)
- [**AgentElement Properties**](./AgentElement Properties/README.md)
- [**AgentElement Methods**](./AgentElement Methods/README.md)
- [**AgentElement Fields**](./AgentElement Fields/README.md)
