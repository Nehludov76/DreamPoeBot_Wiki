# HeistAllyEquipmentElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HeistAllyEquipmentElement"]


```csharp
public class HeistAllyEquipmentElement : Element
```
...
```csharp
public ref class HeistAllyEquipmentElement : public Element
```
...
The HeistAllyEquipmentElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HeistAllyEquipmentElement | Initializes a new instance of the HeistAllyEquipmentElement class |
...
## Дочерние разделы
- [**HeistAllyEquipmentElement Constructor **](./HeistAllyEquipmentElement Constructor/README.md)
- [**HeistAllyEquipmentElement Properties**](./HeistAllyEquipmentElement Properties/README.md)
- [**HeistAllyEquipmentElement Methods**](./HeistAllyEquipmentElement Methods/README.md)
- [**HeistAllyEquipmentElement Fields**](./HeistAllyEquipmentElement Fields/README.md)
