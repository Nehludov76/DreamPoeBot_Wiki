# UltimatumRewardUiElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.UltimatumRewardUiElement"]
...
```csharp
public ref class UltimatumRewardUiElement : public Element
```
...
The UltimatumRewardUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | UltimatumRewardUiElement | Initializes a new instance of the UltimatumRewardUiElement class |
...
## Дочерние разделы
- [**UltimatumRewardUiElement Constructor **](./UltimatumRewardUiElement Constructor/README.md)
- [**UltimatumRewardUiElement Properties**](./UltimatumRewardUiElement Properties/README.md)
- [**UltimatumRewardUiElement Methods**](./UltimatumRewardUiElement Methods/README.md)
- [**UltimatumRewardUiElement Fields**](./UltimatumRewardUiElement Fields/README.md)
