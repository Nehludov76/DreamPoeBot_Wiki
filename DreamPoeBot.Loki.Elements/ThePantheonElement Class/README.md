...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ThePantheonElement"]
...
```csharp
public ref class ThePantheonElement : public Element
```
...
The ThePantheonElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ThePantheonElement | Initializes a new instance of the ThePantheonElement class |
...
## Дочерние разделы
- [**ThePantheonElement Constructor **](./ThePantheonElement Constructor/README.md)
- [**ThePantheonElement Properties**](./ThePantheonElement Properties/README.md)
- [**ThePantheonElement Methods**](./ThePantheonElement Methods/README.md)
- [**ThePantheonElement Fields**](./ThePantheonElement Fields/README.md)
