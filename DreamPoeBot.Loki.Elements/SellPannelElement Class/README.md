...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SellPannelElement"]
...
```csharp
public ref class SellPannelElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | SellPannelElement | Initializes a new instance of the SellPannelElement class |
...
## Дочерние разделы
- [**SellPannelElement Constructor **](./SellPannelElement Constructor/README.md)
- [**SellPannelElement Properties**](./SellPannelElement Properties/README.md)
- [**SellPannelElement Methods**](./SellPannelElement Methods/README.md)
- [**SellPannelElement Fields**](./SellPannelElement Fields/README.md)
