...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.CursorElement"]
...
```csharp
public ref class CursorElement : public Element
```
...
The CursorElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CursorElement | Initializes a new instance of the CursorElement class |
...
## Дочерние разделы
- [**CursorElement Constructor **](./CursorElement Constructor/README.md)
- [**CursorElement Properties**](./CursorElement Properties/README.md)
- [**CursorElement Methods**](./CursorElement Methods/README.md)
- [**CursorElement Fields**](./CursorElement Fields/README.md)
