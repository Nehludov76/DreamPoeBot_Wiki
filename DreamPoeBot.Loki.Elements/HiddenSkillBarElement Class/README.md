...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HiddenSkillBarElement"]
...
```csharp
public ref class HiddenSkillBarElement : public Element
```
...
The HiddenSkillBarElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HiddenSkillBarElement | Initializes a new instance of the HiddenSkillBarElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | AttackInPlaceElement |  |
...
## Дочерние разделы
- [**HiddenSkillBarElement Constructor **](./HiddenSkillBarElement Constructor/README.md)
- [**HiddenSkillBarElement Properties**](./HiddenSkillBarElement Properties/README.md)
- [**HiddenSkillBarElement Methods**](./HiddenSkillBarElement Methods/README.md)
- [**HiddenSkillBarElement Fields**](./HiddenSkillBarElement Fields/README.md)
