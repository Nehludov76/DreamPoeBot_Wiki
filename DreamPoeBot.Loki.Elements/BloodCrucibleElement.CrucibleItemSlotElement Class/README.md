# BloodCrucibleElement.CrucibleItemSlotElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BloodCrucibleElement.CrucibleItemSlotElement"]
...
```csharp
public ref class CrucibleItemSlotElement : public Element
```
...
The BloodCrucibleElement CrucibleItemSlotElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BloodCrucibleElement CrucibleItemSlotElement | Initializes a new instance of the BloodCrucibleElement CrucibleItemSlotElement class |
...
## Дочерние разделы
- [**BloodCrucibleElement.CrucibleItemSlotElement Constructor **](./BloodCrucibleElement.CrucibleItemSlotElement Constructor/README.md)
- [**CrucibleItemSlotElement Properties**](./CrucibleItemSlotElement Properties/README.md)
- [**CrucibleItemSlotElement Methods**](./CrucibleItemSlotElement Methods/README.md)
- [**CrucibleItemSlotElement Fields**](./CrucibleItemSlotElement Fields/README.md)
