...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HideoutSelectionElement"]
...
```csharp
public ref class HideoutSelectionElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | HideoutSelectionElement | Initializes a new instance of the HideoutSelectionElement class |
...
## Дочерние разделы
- [**HideoutSelectionElement Constructor **](./HideoutSelectionElement Constructor/README.md)
- [**HideoutSelectionElement Properties**](./HideoutSelectionElement Properties/README.md)
- [**HideoutSelectionElement Methods**](./HideoutSelectionElement Methods/README.md)
- [**HideoutSelectionElement Fields**](./HideoutSelectionElement Fields/README.md)
