...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.DivineFontUiElement"]


```csharp
public class DivineFontUiElement : Element
```
...
```csharp
public ref class DivineFontUiElement : public Element
```
...
The DivineFontUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | DivineFontUiElement | Initializes a new instance of the DivineFontUiElement class |
...
## Дочерние разделы
- [**DivineFontUiElement Constructor **](./DivineFontUiElement Constructor/README.md)
- [**DivineFontUiElement Properties**](./DivineFontUiElement Properties/README.md)
- [**DivineFontUiElement Methods**](./DivineFontUiElement Methods/README.md)
- [**DivineFontUiElement Fields**](./DivineFontUiElement Fields/README.md)
