...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.GenericComboBoxElement"]


```csharp
public class GenericComboBoxElement : Element
```
...
```csharp
public ref class GenericComboBoxElement : public Element
```
...
The GenericComboBoxElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | GenericComboBoxElement | Initializes a new instance of the GenericComboBoxElement class |
...
## Дочерние разделы
- [**GenericComboBoxElement Constructor **](./GenericComboBoxElement Constructor/README.md)
- [**GenericComboBoxElement Properties**](./GenericComboBoxElement Properties/README.md)
- [**GenericComboBoxElement Methods**](./GenericComboBoxElement Methods/README.md)
- [**GenericComboBoxElement Fields**](./GenericComboBoxElement Fields/README.md)
