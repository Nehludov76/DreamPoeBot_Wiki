...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ShowRitualRewardElement"]
...
```csharp
public ref class ShowRitualRewardElement : public Element
```
...
The ShowRitualRewardElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ShowRitualRewardElement | Initializes a new instance of the ShowRitualRewardElement class |
...
## Дочерние разделы
- [**ShowRitualRewardElement Constructor **](./ShowRitualRewardElement Constructor/README.md)
- [**ShowRitualRewardElement Properties**](./ShowRitualRewardElement Properties/README.md)
- [**ShowRitualRewardElement Methods**](./ShowRitualRewardElement Methods/README.md)
- [**ShowRitualRewardElement Fields**](./ShowRitualRewardElement Fields/README.md)
