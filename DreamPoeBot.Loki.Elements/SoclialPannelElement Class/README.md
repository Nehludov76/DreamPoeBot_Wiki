...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SoclialPannelElement"]
...
```csharp
public ref class SoclialPannelElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | SoclialPannelElement | Initializes a new instance of the SoclialPannelElement class |
...
## Дочерние разделы
- [**SoclialPannelElement Constructor **](./SoclialPannelElement Constructor/README.md)
- [**SoclialPannelElement Properties**](./SoclialPannelElement Properties/README.md)
- [**SoclialPannelElement Methods**](./SoclialPannelElement Methods/README.md)
- [**SoclialPannelElement Fields**](./SoclialPannelElement Fields/README.md)
