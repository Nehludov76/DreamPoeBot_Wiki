...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.LabMetamorphElement"]
...
```csharp
public ref class LabMetamorphElement : public Element
```
...
The LabMetamorphElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | LabMetamorphElement | Initializes a new instance of the LabMetamorphElement class |
...
## Дочерние разделы
- [**LabMetamorphElement Constructor **](./LabMetamorphElement Constructor/README.md)
- [**LabMetamorphElement Properties**](./LabMetamorphElement Properties/README.md)
- [**LabMetamorphElement Methods**](./LabMetamorphElement Methods/README.md)
- [**LabMetamorphElement Fields**](./LabMetamorphElement Fields/README.md)
