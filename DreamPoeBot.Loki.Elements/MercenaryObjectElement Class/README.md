...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MercenaryObjectElement"]


```csharp
public class MercenaryObjectElement : Element
```
...
```csharp
public ref class MercenaryObjectElement : public Element
```
...
The MercenaryObjectElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MercenaryObjectElement | Initializes a new instance of the MercenaryObjectElement class |
...
## Дочерние разделы
- [**MercenaryObjectElement Constructor **](./MercenaryObjectElement Constructor/README.md)
- [**MercenaryObjectElement Properties**](./MercenaryObjectElement Properties/README.md)
- [**MercenaryObjectElement Methods**](./MercenaryObjectElement Methods/README.md)
- [**MercenaryObjectElement Fields**](./MercenaryObjectElement Fields/README.md)
