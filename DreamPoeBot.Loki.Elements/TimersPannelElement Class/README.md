...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.TimersPannelElement"]
...
```csharp
public ref class TimersPannelElement : public Element
```
...
The TimersPannelElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | TimersPannelElement | Initializes a new instance of the TimersPannelElement class |
...
## Дочерние разделы
- [**TimersPannelElement Constructor **](./TimersPannelElement Constructor/README.md)
- [**TimersPannelElement Properties**](./TimersPannelElement Properties/README.md)
- [**TimersPannelElement Methods**](./TimersPannelElement Methods/README.md)
- [**TimersPannelElement Fields**](./TimersPannelElement Fields/README.md)
