...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.StashElement"]
...
```csharp
public ref class StashElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | StashElement | Initializes a new instance of the StashElement class |
...
|  | IsRightTabsContainerElementVisible |  |
|  | IsTabListButtonVisible |  |
...
|  | RightTabsContainerElement |  |
|  | RightTabsContainerHeight |  |
|  | RightTabsContainerScrollDown |  |
|  | RightTabsContainerScrollUp |  |
|  | RightTabsContainerYOffset |  |
...
## Дочерние разделы
- [**StashElement Constructor **](./StashElement Constructor/README.md)
- [**StashElement Properties**](./StashElement Properties/README.md)
- [**StashElement Methods**](./StashElement Methods/README.md)
- [**StashElement Fields**](./StashElement Fields/README.md)
