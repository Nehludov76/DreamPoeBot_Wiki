...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ContextMenuUiElement"]
...
```csharp
public ref class ContextMenuUiElement : public Element
```
...
The ContextMenuUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ContextMenuUiElement | Initializes a new instance of the ContextMenuUiElement class |
...
## Дочерние разделы
- [**ContextMenuUiElement Constructor **](./ContextMenuUiElement Constructor/README.md)
- [**ContextMenuUiElement Properties**](./ContextMenuUiElement Properties/README.md)
- [**ContextMenuUiElement Methods**](./ContextMenuUiElement Methods/README.md)
- [**ContextMenuUiElement Fields**](./ContextMenuUiElement Fields/README.md)
