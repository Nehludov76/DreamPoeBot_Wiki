...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.WindowState"]
...
```csharp
public ref class WindowState : public Element
```
...
The WindowState type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | WindowState | Initializes a new instance of the WindowState class |
...
## Дочерние разделы
- [**WindowState Constructor **](./WindowState Constructor/README.md)
- [**WindowState Properties**](./WindowState Properties/README.md)
- [**WindowState Methods**](./WindowState Methods/README.md)
- [**WindowState Fields**](./WindowState Fields/README.md)
