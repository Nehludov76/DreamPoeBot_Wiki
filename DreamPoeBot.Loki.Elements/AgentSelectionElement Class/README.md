...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AgentSelectionElement"]
...
```csharp
public ref class AgentSelectionElement : public Element
```
...
The AgentSelectionElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AgentSelectionElement | Initializes a new instance of the AgentSelectionElement class |
...
## Дочерние разделы
- [**AgentSelectionElement Constructor **](./AgentSelectionElement Constructor/README.md)
- [**AgentSelectionElement Properties**](./AgentSelectionElement Properties/README.md)
- [**AgentSelectionElement Methods**](./AgentSelectionElement Methods/README.md)
- [**AgentSelectionElement Fields**](./AgentSelectionElement Fields/README.md)
