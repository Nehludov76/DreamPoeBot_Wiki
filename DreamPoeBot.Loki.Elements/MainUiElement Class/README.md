...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MainUiElement"]
...
```csharp
public ref class MainUiElement : public Element
```
...
The MainUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MainUiElement | Initializes a new instance of the MainUiElement class |
...
## Дочерние разделы
- [**MainUiElement Constructor **](./MainUiElement Constructor/README.md)
- [**MainUiElement Properties**](./MainUiElement Properties/README.md)
- [**MainUiElement Methods**](./MainUiElement Methods/README.md)
- [**MainUiElement Fields**](./MainUiElement Fields/README.md)
