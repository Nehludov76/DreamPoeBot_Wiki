...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SanctumArchivesElement"]
...
```csharp
public ref class SanctumArchivesElement : public Element
```
...
The SanctumArchivesElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SanctumArchivesElement | Initializes a new instance of the SanctumArchivesElement class |
...
## Дочерние разделы
- [**SanctumArchivesElement Constructor **](./SanctumArchivesElement Constructor/README.md)
- [**SanctumArchivesElement Properties**](./SanctumArchivesElement Properties/README.md)
- [**SanctumArchivesElement Methods**](./SanctumArchivesElement Methods/README.md)
- [**SanctumArchivesElement Fields**](./SanctumArchivesElement Fields/README.md)
