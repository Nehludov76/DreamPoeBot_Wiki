...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AnointingElement"]
...
```csharp
public ref class AnointingElement : public Element
```
...
The AnointingElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AnointingElement | Initializes a new instance of the AnointingElement class |
...
## Дочерние разделы
- [**AnointingElement Constructor **](./AnointingElement Constructor/README.md)
- [**AnointingElement Properties**](./AnointingElement Properties/README.md)
- [**AnointingElement Methods**](./AnointingElement Methods/README.md)
- [**AnointingElement Fields**](./AnointingElement Fields/README.md)
