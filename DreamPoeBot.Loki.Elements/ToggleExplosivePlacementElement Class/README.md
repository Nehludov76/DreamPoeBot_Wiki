# ToggleExplosivePlacementElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ToggleExplosivePlacementElement"]
...
```csharp
public ref class ToggleExplosivePlacementElement : public Element
```
...
The ToggleExplosivePlacementElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ToggleExplosivePlacementElement | Initializes a new instance of the ToggleExplosivePlacementElement class |
...
## Дочерние разделы
- [**ToggleExplosivePlacementElement Constructor **](./ToggleExplosivePlacementElement Constructor/README.md)
- [**ToggleExplosivePlacementElement Properties**](./ToggleExplosivePlacementElement Properties/README.md)
- [**ToggleExplosivePlacementElement Methods**](./ToggleExplosivePlacementElement Methods/README.md)
- [**ToggleExplosivePlacementElement Fields**](./ToggleExplosivePlacementElement Fields/README.md)
