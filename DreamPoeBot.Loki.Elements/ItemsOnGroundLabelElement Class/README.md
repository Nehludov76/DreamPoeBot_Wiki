# ItemsOnGroundLabelElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ItemsOnGroundLabelElement"]
...
```csharp
public ref class ItemsOnGroundLabelElement : public Element
```
...
The ItemsOnGroundLabelElement type exposes the following members.
...
- [**ItemsOnGroundLabelElement Properties**](./ItemsOnGroundLabelElement Properties/README.md)
- [**ItemsOnGroundLabelElement Methods**](./ItemsOnGroundLabelElement Methods/README.md)
- [**ItemsOnGroundLabelElement Fields**](./ItemsOnGroundLabelElement Fields/README.md)
