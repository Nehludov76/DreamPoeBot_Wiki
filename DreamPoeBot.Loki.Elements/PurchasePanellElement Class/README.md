...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PurchasePanellElement"]
...
```csharp
public ref class PurchasePanellElement : public Element
```
...
The PurchasePanellElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PurchasePanellElement | Initializes a new instance of the PurchasePanellElement class |
...
## Дочерние разделы
- [**PurchasePanellElement Constructor **](./PurchasePanellElement Constructor/README.md)
- [**PurchasePanellElement Properties**](./PurchasePanellElement Properties/README.md)
- [**PurchasePanellElement Methods**](./PurchasePanellElement Methods/README.md)
- [**PurchasePanellElement Fields**](./PurchasePanellElement Fields/README.md)
