# BreachProgressBarElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BreachProgressBarElement"]


```csharp
public class BreachProgressBarElement : Element
```
...
```csharp
public ref class BreachProgressBarElement : public Element
```
...
| Name | Description |
| --- | --- |
| BreachProgressBarElement | Initializes a new instance of the BreachProgressBarElement class |
