...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapElement"]
...
```csharp
public ref class MapElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | MapElement | Initializes a new instance of the MapElement class |
...
|  | LargeMap |  |
|  | LargeMapDefaultShiftX |  |
|  | LargeMapDefaultShiftY |  |
|  | LargeMapShiftX |  |
|  | LargeMapShiftY |  |
|  | LargeMapZoom |  |
...
|  | SmallMinimap |  |
|  | SmallMinimapDefaultX |  |
|  | SmallMinimapDefaultY |  |
|  | SmallMinimapX |  |
|  | SmallMinimapY |  |
|  | SmallMinimapZoom |  |
...
## Дочерние разделы
- [**MapElement Constructor **](./MapElement Constructor/README.md)
- [**MapElement Properties**](./MapElement Properties/README.md)
- [**MapElement Methods**](./MapElement Methods/README.md)
- [**MapElement Fields**](./MapElement Fields/README.md)
