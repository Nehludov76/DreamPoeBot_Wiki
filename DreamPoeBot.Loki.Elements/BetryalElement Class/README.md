...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BetryalElement"]
...
```csharp
public ref class BetryalElement : public Element
```
...
The BetryalElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BetryalElement | Initializes a new instance of the BetryalElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | BargainClickPosition |  |
|  | BetrayClickPosition |  |
...
|  | InterrogateClickPosition |  |
|  | IsBargainVisible |  |
|  | IsBetrayVisible |  |
|  | IsEnable | (Inherited from Element .) |
|  | IsExecuteVisible |  |
|  | IsInterrogateVisible |  |
...
## Дочерние разделы
- [**BetryalElement Constructor **](./BetryalElement Constructor/README.md)
- [**BetryalElement Properties**](./BetryalElement Properties/README.md)
- [**BetryalElement Methods**](./BetryalElement Methods/README.md)
- [**BetryalElement Fields**](./BetryalElement Fields/README.md)
