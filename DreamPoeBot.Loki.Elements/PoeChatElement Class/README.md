...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PoeChatElement"]
...
```csharp
public ref class PoeChatElement : public Element
```
...
The PoeChatElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PoeChatElement | Initializes a new instance of the PoeChatElement class |
...
## Дочерние разделы
- [**PoeChatElement Constructor **](./PoeChatElement Constructor/README.md)
- [**PoeChatElement Properties**](./PoeChatElement Properties/README.md)
- [**PoeChatElement Methods**](./PoeChatElement Methods/README.md)
- [**PoeChatElement Fields**](./PoeChatElement Fields/README.md)
