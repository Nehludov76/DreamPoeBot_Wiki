...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PartyHudUIElement"]
...
```csharp
public ref class PartyHudUIElement : public Element
```
...
The PartyHudUIElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PartyHudUIElement | Initializes a new instance of the PartyHudUIElement class |
...
## Дочерние разделы
- [**PartyHudUIElement Constructor **](./PartyHudUIElement Constructor/README.md)
- [**PartyHudUIElement Properties**](./PartyHudUIElement Properties/README.md)
- [**PartyHudUIElement Methods**](./PartyHudUIElement Methods/README.md)
- [**PartyHudUIElement Fields**](./PartyHudUIElement Fields/README.md)
