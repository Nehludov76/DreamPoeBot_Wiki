...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.LoginPannelElement"]
...
```csharp
public ref class LoginPannelElement : public Element
```
...
The LoginPannelElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | LoginPannelElement | Initializes a new instance of the LoginPannelElement class |
...
|  | LoginButtonPosition |  |
|  | LoginFrame |  |
|  | LoginTextboxPosition |  |
|  | LoginTextBoxText |  |
|  | LoginTextboxTextAddress |  |
...
## Дочерние разделы
- [**LoginPannelElement Constructor **](./LoginPannelElement Constructor/README.md)
- [**LoginPannelElement Properties**](./LoginPannelElement Properties/README.md)
- [**LoginPannelElement Methods**](./LoginPannelElement Methods/README.md)
- [**LoginPannelElement Fields**](./LoginPannelElement Fields/README.md)
