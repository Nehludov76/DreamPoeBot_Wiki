...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HeistContractElement"]
...
```csharp
public ref class HeistContractElement : public Element
```
...
The HeistContractElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HeistContractElement | Initializes a new instance of the HeistContractElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | AgentSelectionPannelElement |  |
|  | ChildCount | (Inherited from Element .) |
|  | Children | (Inherited from Element .) |
|  | ContractDettailsElement |  |
|  | ContractFeesElement |  |
...
## Дочерние разделы
- [**HeistContractElement Constructor **](./HeistContractElement Constructor/README.md)
- [**HeistContractElement Properties**](./HeistContractElement Properties/README.md)
- [**HeistContractElement Methods**](./HeistContractElement Methods/README.md)
- [**HeistContractElement Fields**](./HeistContractElement Fields/README.md)
