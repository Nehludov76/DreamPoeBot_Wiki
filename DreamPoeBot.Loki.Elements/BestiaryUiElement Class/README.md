...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BestiaryUiElement"]


```csharp
public class BestiaryUiElement : Element
```
...
```csharp
public ref class BestiaryUiElement : public Element
```
...
The BestiaryUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BestiaryUiElement | Initializes a new instance of the BestiaryUiElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | CapturedBeastCategoryButton |  |
|  | CapturedBeastElement |  |
...
## Дочерние разделы
- [**BestiaryUiElement Constructor **](./BestiaryUiElement Constructor/README.md)
- [**BestiaryUiElement Properties**](./BestiaryUiElement Properties/README.md)
- [**BestiaryUiElement Methods**](./BestiaryUiElement Methods/README.md)
- [**BestiaryUiElement Fields**](./BestiaryUiElement Fields/README.md)
