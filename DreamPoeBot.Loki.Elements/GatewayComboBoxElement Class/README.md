...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.GatewayComboBoxElement"]


```csharp
public class GatewayComboBoxElement : GenericComboBoxElement
```
...
```csharp
public ref class GatewayComboBoxElement : public GenericComboBoxElement
```
...
| Name | Description |
| --- | --- |
| GatewayComboBoxElement | Initializes a new instance of the GatewayComboBoxElement class |
