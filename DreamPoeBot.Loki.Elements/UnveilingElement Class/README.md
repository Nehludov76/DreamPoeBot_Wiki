...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.UnveilingElement"]
...
```csharp
public ref class UnveilingElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | UnveilingElement | Initializes a new instance of the UnveilingElement class |
...
## Дочерние разделы
- [**UnveilingElement Constructor **](./UnveilingElement Constructor/README.md)
- [**UnveilingElement Properties**](./UnveilingElement Properties/README.md)
- [**UnveilingElement Methods**](./UnveilingElement Methods/README.md)
- [**UnveilingElement Fields**](./UnveilingElement Fields/README.md)
