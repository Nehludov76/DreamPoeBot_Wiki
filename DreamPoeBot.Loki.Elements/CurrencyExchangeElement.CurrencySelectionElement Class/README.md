# CurrencyExchangeElement.CurrencySelectionElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.CurrencyExchangeElement.CurrencySelectionElement"]


```csharp
public class CurrencySelectionElement : Element
```
...
```csharp
public ref class CurrencySelectionElement : public Element
```
...
The CurrencyExchangeElement CurrencySelectionElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CurrencyExchangeElement CurrencySelectionElement | Initializes a new instance of the CurrencyExchangeElement CurrencySelectionElement class |
...
|  | ClearSearchBoxButtonElement |  |
|  | ControlType | (Inherited from Element .) |
|  | CurrencyEntryList |  |
|  | CurrencyPannelElement |  |
|  | CurrencyScrollBarElement |  |
...
## Дочерние разделы
- [**CurrencyExchangeElement.CurrencySelectionElement Constructor **](./CurrencyExchangeElement.CurrencySelectionElement Constructor/README.md)
- [**CurrencySelectionElement Properties**](./CurrencySelectionElement Properties/README.md)
- [**CurrencySelectionElement Methods**](./CurrencySelectionElement Methods/README.md)
- [**CurrencySelectionElement Fields**](./CurrencySelectionElement Fields/README.md)
