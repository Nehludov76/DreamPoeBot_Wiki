...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.WorldElement"]
...
```csharp
public ref class WorldElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | WorldElement | Initializes a new instance of the WorldElement class |
...
|  | KingsmarchClickLocation |  |
|  | KingsmarchWayPoint |  |
|  | LaboratoryClickLocation |  |
|  | LaboratoryWayPoint |  |
|  | LabyrintClickLocation |  |
|  | LabyrintWayPoint |  |
|  | M | (Inherited from RemoteMemoryObject .) |
|  | MenagerieClickLocation |  |
|  | MenagerieWayPoint |  |
|  | MineClickLocation |  |
|  | MineWayPoint |  |
...
## Дочерние разделы
- [**WorldElement Constructor **](./WorldElement Constructor/README.md)
- [**WorldElement Properties**](./WorldElement Properties/README.md)
- [**WorldElement Methods**](./WorldElement Methods/README.md)
- [**WorldElement Fields**](./WorldElement Fields/README.md)
