# ArchnemesisEncounterStartPannelElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ArchnemesisEncounterStartPannelElement"]
...
```csharp
public ref class ArchnemesisEncounterStartPannelElement : public Element
```
...
The ArchnemesisEncounterStartPannelElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ArchnemesisEncounterStartPannelElement | Initializes a new instance of the ArchnemesisEncounterStartPannelElement class |
...
## Дочерние разделы
- [**ArchnemesisEncounterStartPannelElement Constructor **](./ArchnemesisEncounterStartPannelElement Constructor/README.md)
- [**ArchnemesisEncounterStartPannelElement Properties**](./ArchnemesisEncounterStartPannelElement Properties/README.md)
- [**ArchnemesisEncounterStartPannelElement Methods**](./ArchnemesisEncounterStartPannelElement Methods/README.md)
- [**ArchnemesisEncounterStartPannelElement Fields**](./ArchnemesisEncounterStartPannelElement Fields/README.md)
