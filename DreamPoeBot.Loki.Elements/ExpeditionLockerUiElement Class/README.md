# ExpeditionLockerUiElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ExpeditionLockerUiElement"]


```csharp
public class ExpeditionLockerUiElement : Element
```
...
```csharp
public ref class ExpeditionLockerUiElement : public Element
```
...
The ExpeditionLockerUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ExpeditionLockerUiElement | Initializes a new instance of the ExpeditionLockerUiElement class |
...
## Дочерние разделы
- [**ExpeditionLockerUiElement Constructor **](./ExpeditionLockerUiElement Constructor/README.md)
- [**ExpeditionLockerUiElement Properties**](./ExpeditionLockerUiElement Properties/README.md)
- [**ExpeditionLockerUiElement Methods**](./ExpeditionLockerUiElement Methods/README.md)
- [**ExpeditionLockerUiElement Fields**](./ExpeditionLockerUiElement Fields/README.md)
