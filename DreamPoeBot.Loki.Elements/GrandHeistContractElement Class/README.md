# GrandHeistContractElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.GrandHeistContractElement"]
...
```csharp
public ref class GrandHeistContractElement : public Element
```
...
The GrandHeistContractElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | GrandHeistContractElement | Initializes a new instance of the GrandHeistContractElement class |
...
## Дочерние разделы
- [**GrandHeistContractElement Constructor **](./GrandHeistContractElement Constructor/README.md)
- [**GrandHeistContractElement Properties**](./GrandHeistContractElement Properties/README.md)
- [**GrandHeistContractElement Methods**](./GrandHeistContractElement Methods/README.md)
- [**GrandHeistContractElement Fields**](./GrandHeistContractElement Fields/README.md)
