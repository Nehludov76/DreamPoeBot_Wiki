...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HeisLockerElement"]
...
```csharp
public ref class HeisLockerElement : public Element
```
...
The HeisLockerElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HeisLockerElement | Initializes a new instance of the HeisLockerElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | BlueprintsCategoryElement |  |
|  | ChildCount | (Inherited from Element .) |
|  | Children | (Inherited from Element .) |
|  | ContrantsCategoryElement |  |
...
## Дочерние разделы
- [**HeisLockerElement Constructor **](./HeisLockerElement Constructor/README.md)
- [**HeisLockerElement Properties**](./HeisLockerElement Properties/README.md)
- [**HeisLockerElement Methods**](./HeisLockerElement Methods/README.md)
- [**HeisLockerElement Fields**](./HeisLockerElement Fields/README.md)
