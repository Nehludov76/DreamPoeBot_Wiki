# MapsTabElement.TierElementClass Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapsTabElement.TierElementClass"]
...
```csharp
public ref class TierElementClass : public Element
```
...
The MapsTabElement TierElementClass type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MapsTabElement TierElementClass | Initializes a new instance of the MapsTabElement TierElementClass class |
...
## Дочерние разделы
- [**MapsTabElement.TierElementClass Constructor **](./MapsTabElement.TierElementClass Constructor/README.md)
- [**TierElementClass Properties**](./TierElementClass Properties/README.md)
- [**TierElementClass Methods**](./TierElementClass Methods/README.md)
- [**TierElementClass Fields**](./TierElementClass Fields/README.md)
