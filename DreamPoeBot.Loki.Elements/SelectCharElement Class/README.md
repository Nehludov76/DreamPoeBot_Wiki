...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SelectCharElement"]


```csharp
public class SelectCharElement : Element
```
...
```csharp
public ref class SelectCharElement : public Element
```
...
The SelectCharElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SelectCharElement | Initializes a new instance of the SelectCharElement class |
...
## Дочерние разделы
- [**SelectCharElement Constructor **](./SelectCharElement Constructor/README.md)
- [**SelectCharElement Properties**](./SelectCharElement Properties/README.md)
- [**SelectCharElement Methods**](./SelectCharElement Methods/README.md)
- [**SelectCharElement Fields**](./SelectCharElement Fields/README.md)
