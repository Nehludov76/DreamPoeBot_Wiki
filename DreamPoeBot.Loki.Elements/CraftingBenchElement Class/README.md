...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.CraftingBenchElement"]
...
```csharp
public ref class CraftingBenchElement : public Element
```
...
The CraftingBenchElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CraftingBenchElement | Initializes a new instance of the CraftingBenchElement class |
...
## Дочерние разделы
- [**CraftingBenchElement Constructor **](./CraftingBenchElement Constructor/README.md)
- [**CraftingBenchElement Properties**](./CraftingBenchElement Properties/README.md)
- [**CraftingBenchElement Methods**](./CraftingBenchElement Methods/README.md)
- [**CraftingBenchElement Fields**](./CraftingBenchElement Fields/README.md)
