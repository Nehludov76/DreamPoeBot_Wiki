...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.OptionsElement"]
...
```csharp
public ref class OptionsElement : public Element
```
...
The OptionsElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | OptionsElement | Initializes a new instance of the OptionsElement class |
...
## Дочерние разделы
- [**OptionsElement Constructor **](./OptionsElement Constructor/README.md)
- [**OptionsElement Properties**](./OptionsElement Properties/README.md)
- [**OptionsElement Methods**](./OptionsElement Methods/README.md)
- [**OptionsElement Fields**](./OptionsElement Fields/README.md)
