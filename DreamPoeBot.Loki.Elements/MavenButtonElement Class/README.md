...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MavenButtonElement"]
...
```csharp
public ref class MavenButtonElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | MavenButtonElement | Initializes a new instance of the MavenButtonElement class |
...
## Дочерние разделы
- [**MavenButtonElement Constructor **](./MavenButtonElement Constructor/README.md)
- [**MavenButtonElement Properties**](./MavenButtonElement Properties/README.md)
- [**MavenButtonElement Methods**](./MavenButtonElement Methods/README.md)
- [**MavenButtonElement Fields**](./MavenButtonElement Fields/README.md)
