...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HeistDoorElement"]


```csharp
public class HeistDoorElement : Element
```
...
```csharp
public ref class HeistDoorElement : public Element
```
...
The HeistDoorElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HeistDoorElement | Initializes a new instance of the HeistDoorElement class |
...
## Дочерние разделы
- [**HeistDoorElement Constructor **](./HeistDoorElement Constructor/README.md)
- [**HeistDoorElement Properties**](./HeistDoorElement Properties/README.md)
- [**HeistDoorElement Methods**](./HeistDoorElement Methods/README.md)
- [**HeistDoorElement Fields**](./HeistDoorElement Fields/README.md)
