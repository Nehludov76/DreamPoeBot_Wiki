...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.RitualFavorElement"]
...
```csharp
public ref class RitualFavorElement : public Element
```
...
The RitualFavorElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | RitualFavorElement | Initializes a new instance of the RitualFavorElement class |
...
## Дочерние разделы
- [**RitualFavorElement Constructor **](./RitualFavorElement Constructor/README.md)
- [**RitualFavorElement Properties**](./RitualFavorElement Properties/README.md)
- [**RitualFavorElement Methods**](./RitualFavorElement Methods/README.md)
- [**RitualFavorElement Fields**](./RitualFavorElement Fields/README.md)
