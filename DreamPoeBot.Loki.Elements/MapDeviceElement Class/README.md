...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapDeviceElement"]
...
```csharp
public ref class MapDeviceElement : public Element
```
...
The MapDeviceElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MapDeviceElement | Initializes a new instance of the MapDeviceElement class |
...
## Дочерние разделы
- [**MapDeviceElement Constructor **](./MapDeviceElement Constructor/README.md)
- [**MapDeviceElement Properties**](./MapDeviceElement Properties/README.md)
- [**MapDeviceElement Methods**](./MapDeviceElement Methods/README.md)
- [**MapDeviceElement Fields**](./MapDeviceElement Fields/README.md)
