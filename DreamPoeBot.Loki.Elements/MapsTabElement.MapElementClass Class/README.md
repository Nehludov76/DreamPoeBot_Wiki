# MapsTabElement.MapElementClass Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MapsTabElement.MapElementClass"]
...
```csharp
public ref class MapElementClass : public Element
```
...
The MapsTabElement MapElementClass type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MapsTabElement MapElementClass | Initializes a new instance of the MapsTabElement MapElementClass class |
...
## Дочерние разделы
- [**MapsTabElement.MapElementClass Constructor **](./MapsTabElement.MapElementClass Constructor/README.md)
- [**MapElementClass Properties**](./MapElementClass Properties/README.md)
- [**MapElementClass Methods**](./MapElementClass Methods/README.md)
- [**MapElementClass Fields**](./MapElementClass Fields/README.md)
