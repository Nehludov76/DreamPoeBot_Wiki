...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ProphecyElement"]
...
```csharp
public ref class ProphecyElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | ProphecyElement | Initializes a new instance of the ProphecyElement class |
...
## Дочерние разделы
- [**ProphecyElement Constructor **](./ProphecyElement Constructor/README.md)
- [**ProphecyElement Properties**](./ProphecyElement Properties/README.md)
- [**ProphecyElement Methods**](./ProphecyElement Methods/README.md)
- [**ProphecyElement Fields**](./ProphecyElement Fields/README.md)
