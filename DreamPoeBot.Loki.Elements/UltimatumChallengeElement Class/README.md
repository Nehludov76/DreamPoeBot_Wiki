# UltimatumChallengeElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.UltimatumChallengeElement"]
...
```csharp
public ref class UltimatumChallengeElement : public Element
```
...
The UltimatumChallengeElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | UltimatumChallengeElement | Initializes a new instance of the UltimatumChallengeElement class |
...
## Дочерние разделы
- [**UltimatumChallengeElement Constructor **](./UltimatumChallengeElement Constructor/README.md)
- [**UltimatumChallengeElement Properties**](./UltimatumChallengeElement Properties/README.md)
- [**UltimatumChallengeElement Methods**](./UltimatumChallengeElement Methods/README.md)
- [**UltimatumChallengeElement Fields**](./UltimatumChallengeElement Fields/README.md)
