# GlobalWarningDialogElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.GlobalWarningDialogElement"]


```csharp
public class GlobalWarningDialogElement : Element
```
...
```csharp
public ref class GlobalWarningDialogElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | GlobalWarningDialogElement | Initializes a new instance of the GlobalWarningDialogElement class |
...
## Дочерние разделы
- [**GlobalWarningDialogElement Constructor **](./GlobalWarningDialogElement Constructor/README.md)
- [**GlobalWarningDialogElement Properties**](./GlobalWarningDialogElement Properties/README.md)
- [**GlobalWarningDialogElement Methods**](./GlobalWarningDialogElement Methods/README.md)
- [**GlobalWarningDialogElement Fields**](./GlobalWarningDialogElement Fields/README.md)
