...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AtlasElement"]
...
```csharp
public ref class AtlasElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | AtlasElement | Initializes a new instance of the AtlasElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | Atlas_TheEaterOfWorldsButtonElement |  |
|  | Atlas_TheMavenButtonElement |  |
|  | Atlas_TheSearingExarchButtonElement |  |
|  | AtlasMapDevice_TheEaterOfWorldsButtonElement |  |
|  | AtlasMapDevice_TheMavenButtonElement |  |
|  | AtlasMapDevice_TheSearingExarchButtonElement |  |
...
## Дочерние разделы
- [**AtlasElement Constructor **](./AtlasElement Constructor/README.md)
- [**AtlasElement Properties**](./AtlasElement Properties/README.md)
- [**AtlasElement Methods**](./AtlasElement Methods/README.md)
- [**AtlasElement Fields**](./AtlasElement Fields/README.md)
