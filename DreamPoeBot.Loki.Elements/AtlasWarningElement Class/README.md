...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AtlasWarningElement"]
...
```csharp
public ref class AtlasWarningElement : public Element
```
...
The AtlasWarningElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AtlasWarningElement | Initializes a new instance of the AtlasWarningElement class |
...
## Дочерние разделы
- [**AtlasWarningElement Constructor **](./AtlasWarningElement Constructor/README.md)
- [**AtlasWarningElement Properties**](./AtlasWarningElement Properties/README.md)
- [**AtlasWarningElement Methods**](./AtlasWarningElement Methods/README.md)
- [**AtlasWarningElement Fields**](./AtlasWarningElement Fields/README.md)
