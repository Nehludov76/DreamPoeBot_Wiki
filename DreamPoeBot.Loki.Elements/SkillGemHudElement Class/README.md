...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SkillGemHudElement"]
...
```csharp
public ref class SkillGemHudElement : public Element
```
...
The SkillGemHudElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SkillGemHudElement | Initializes a new instance of the SkillGemHudElement class |
...
## Дочерние разделы
- [**SkillGemHudElement Constructor **](./SkillGemHudElement Constructor/README.md)
- [**SkillGemHudElement Properties**](./SkillGemHudElement Properties/README.md)
- [**SkillGemHudElement Methods**](./SkillGemHudElement Methods/README.md)
- [**SkillGemHudElement Fields**](./SkillGemHudElement Fields/README.md)
