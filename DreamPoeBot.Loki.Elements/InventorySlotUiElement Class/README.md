...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventorySlotUiElement"]
...
```csharp
public ref class InventorySlotUiElement : public Element
```
