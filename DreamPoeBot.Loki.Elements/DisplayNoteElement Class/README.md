...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.DisplayNoteElement"]
...
```csharp
public ref class DisplayNoteElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | DisplayNoteElement | Initializes a new instance of the DisplayNoteElement class |
...
## Дочерние разделы
- [**DisplayNoteElement Constructor **](./DisplayNoteElement Constructor/README.md)
- [**DisplayNoteElement Properties**](./DisplayNoteElement Properties/README.md)
- [**DisplayNoteElement Methods**](./DisplayNoteElement Methods/README.md)
- [**DisplayNoteElement Fields**](./DisplayNoteElement Fields/README.md)
