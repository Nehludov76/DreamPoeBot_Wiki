...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MetamorphSummonElement"]


```csharp
public class MetamorphSummonElement : Element
```
...
```csharp
public ref class MetamorphSummonElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | MetamorphSummonElement | Initializes a new instance of the MetamorphSummonElement class |
...
## Дочерние разделы
- [**MetamorphSummonElement Constructor **](./MetamorphSummonElement Constructor/README.md)
- [**MetamorphSummonElement Properties**](./MetamorphSummonElement Properties/README.md)
- [**MetamorphSummonElement Methods**](./MetamorphSummonElement Methods/README.md)
- [**MetamorphSummonElement Fields**](./MetamorphSummonElement Fields/README.md)
