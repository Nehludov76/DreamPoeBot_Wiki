...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BlightTowerOption"]
...
```csharp
public ref class BlightTowerOption : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | BlightTowerOption | Initializes a new instance of the BlightTowerOption class |
...
## Дочерние разделы
- [**BlightTowerOption Constructor **](./BlightTowerOption Constructor/README.md)
- [**BlightTowerOption Properties**](./BlightTowerOption Properties/README.md)
- [**BlightTowerOption Methods**](./BlightTowerOption Methods/README.md)
- [**BlightTowerOption Fields**](./BlightTowerOption Fields/README.md)
