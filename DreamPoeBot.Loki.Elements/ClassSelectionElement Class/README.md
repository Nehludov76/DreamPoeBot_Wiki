...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ClassSelectionElement"]


```csharp
public class ClassSelectionElement : Element
```
...
```csharp
public ref class ClassSelectionElement : public Element
```
...
The ClassSelectionElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ClassSelectionElement | Initializes a new instance of the ClassSelectionElement class |
...
## Дочерние разделы
- [**ClassSelectionElement Constructor **](./ClassSelectionElement Constructor/README.md)
- [**ClassSelectionElement Properties**](./ClassSelectionElement Properties/README.md)
- [**ClassSelectionElement Methods**](./ClassSelectionElement Methods/README.md)
- [**ClassSelectionElement Fields**](./ClassSelectionElement Fields/README.md)
