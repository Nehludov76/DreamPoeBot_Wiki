...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HudUIElement"]
...
```csharp
public ref class HudUIElement : public Element
```
...
| Name | Description |
| --- | --- |
| HudUIElement | Initializes a new instance of the HudUIElement class |


| Name | Description |
| --- | --- |
| Address | (Inherited from RemoteMemoryObject .) |
| BloodCrucibleItemReadyElement |
| BloodCrucibleSkillAvailableElement |
| ChildCount | (Inherited from Element .) |
| Children | (Inherited from Element .) |
| ControlType | (Inherited from Element .) |
| DecorationsButtonElement |
| DeliriumEndButton |
| DeliriumEndClickLocation |
...
| ReclaimButtonElement |
| Return_from_unowned_hideout |
| Root | (Inherited from Element .) |
| Scale | (Inherited from Element .) |
| SentinelsElement |
| ShowMenuButtonElement |
| SkipTutorialButton |
| StartBlightEncounter |
| StartBlightEncounterClickLocation |
...
| Zana_Influence_Skill_1_Element |
| Zana_Influence_Skill_2_Element |
| Zana_Influence_Skill_3_Element |
| Zana_Influence_Skill_Bar |
