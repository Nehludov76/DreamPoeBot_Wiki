...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SkillBarElement"]
...
```csharp
public ref class SkillBarElement : public Element
```
...
The SkillBarElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SkillBarElement | Initializes a new instance of the SkillBarElement class |
...
|  | ControlSkillsDictionary |  |
|  | ControlSkillsElements |  |
...
## Дочерние разделы
- [**SkillBarElement Constructor **](./SkillBarElement Constructor/README.md)
- [**SkillBarElement Properties**](./SkillBarElement Properties/README.md)
- [**SkillBarElement Methods**](./SkillBarElement Methods/README.md)
- [**SkillBarElement Fields**](./SkillBarElement Fields/README.md)
