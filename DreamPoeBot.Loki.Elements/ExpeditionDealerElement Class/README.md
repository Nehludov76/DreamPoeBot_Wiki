...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ExpeditionDealerElement"]
...
```csharp
public ref class ExpeditionDealerElement : public Element
```
...
The ExpeditionDealerElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ExpeditionDealerElement | Initializes a new instance of the ExpeditionDealerElement class |
...
## Дочерние разделы
- [**ExpeditionDealerElement Constructor **](./ExpeditionDealerElement Constructor/README.md)
- [**ExpeditionDealerElement Properties**](./ExpeditionDealerElement Properties/README.md)
- [**ExpeditionDealerElement Methods**](./ExpeditionDealerElement Methods/README.md)
- [**ExpeditionDealerElement Fields**](./ExpeditionDealerElement Fields/README.md)
