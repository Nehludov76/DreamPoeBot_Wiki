# ExpeditionDealerElement Methods
...
## Дочерние разделы
- [**GetStashInventoryByIndex Method **](./GetStashInventoryByIndex Method/README.md)
- [**GetStashName Method **](./GetStashName Method/README.md)
