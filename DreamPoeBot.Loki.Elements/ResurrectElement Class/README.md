...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ResurrectElement"]
...
```csharp
public ref class ResurrectElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | ResurrectElement | Initializes a new instance of the ResurrectElement class |
...
|  | ResAtCheckpointClickPos |  |
|  | ResInTownClickPos |  |
|  | ResurrectAtCheckpointEnabled |  |
|  | ResurrectInTownEnabled |  |
...
## Дочерние разделы
- [**ResurrectElement Constructor **](./ResurrectElement Constructor/README.md)
- [**ResurrectElement Properties**](./ResurrectElement Properties/README.md)
- [**ResurrectElement Methods**](./ResurrectElement Methods/README.md)
- [**ResurrectElement Fields**](./ResurrectElement Fields/README.md)
