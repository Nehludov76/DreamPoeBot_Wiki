...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HorticraftingElement"]
...
```csharp
public ref class HorticraftingElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | HorticraftingElement | Initializes a new instance of the HorticraftingElement class |
...
## Дочерние разделы
- [**HorticraftingElement Constructor **](./HorticraftingElement Constructor/README.md)
- [**HorticraftingElement Properties**](./HorticraftingElement Properties/README.md)
- [**HorticraftingElement Methods**](./HorticraftingElement Methods/README.md)
- [**HorticraftingElement Fields**](./HorticraftingElement Fields/README.md)
