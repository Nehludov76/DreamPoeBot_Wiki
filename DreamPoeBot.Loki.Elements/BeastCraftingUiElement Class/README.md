...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BeastCraftingUiElement"]
...
```csharp
public ref class BeastCraftingUiElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | BeastCraftingUiElement | Initializes a new instance of the BeastCraftingUiElement class |
...
## Дочерние разделы
- [**BeastCraftingUiElement Constructor **](./BeastCraftingUiElement Constructor/README.md)
- [**BeastCraftingUiElement Properties**](./BeastCraftingUiElement Properties/README.md)
- [**BeastCraftingUiElement Methods**](./BeastCraftingUiElement Methods/README.md)
- [**BeastCraftingUiElement Fields**](./BeastCraftingUiElement Fields/README.md)
