...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AffinitieCheckbox"]
...
```csharp
public ref class AffinitieCheckbox : public Element
```
...
The AffinitieCheckbox type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AffinitieCheckbox | Initializes a new instance of the AffinitieCheckbox class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | AffinitieEnum | Retrieve a StashTabAffinitiesEnum rapresenting the checkbox affinitie. |
...
|  | IsSelected | Return true if this checkbox is checked. |
...
|  | ClickCheckBox | Click this checkbox. |
...
## Дочерние разделы
- [**AffinitieCheckbox Constructor **](./AffinitieCheckbox Constructor/README.md)
- [**AffinitieCheckbox Properties**](./AffinitieCheckbox Properties/README.md)
- [**AffinitieCheckbox Methods**](./AffinitieCheckbox Methods/README.md)
- [**AffinitieCheckbox Fields**](./AffinitieCheckbox Fields/README.md)
