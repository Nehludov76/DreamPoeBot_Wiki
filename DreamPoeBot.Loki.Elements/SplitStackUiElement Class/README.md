...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SplitStackUiElement"]
...
```csharp
public ref class SplitStackUiElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | SplitStackUiElement | Initializes a new instance of the SplitStackUiElement class |
...
## Дочерние разделы
- [**SplitStackUiElement Constructor **](./SplitStackUiElement Constructor/README.md)
- [**SplitStackUiElement Properties**](./SplitStackUiElement Properties/README.md)
- [**SplitStackUiElement Methods**](./SplitStackUiElement Methods/README.md)
- [**SplitStackUiElement Fields**](./SplitStackUiElement Fields/README.md)
