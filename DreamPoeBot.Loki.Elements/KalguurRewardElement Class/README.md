...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.KalguurRewardElement"]


```csharp
public class KalguurRewardElement : Element
```
...
```csharp
public ref class KalguurRewardElement : public Element
```
...
The KalguurRewardElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | KalguurRewardElement | Initializes a new instance of the KalguurRewardElement class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | ApplyItemFilterElement |  |
...
## Дочерние разделы
- [**KalguurRewardElement Constructor **](./KalguurRewardElement Constructor/README.md)
- [**KalguurRewardElement Properties**](./KalguurRewardElement Properties/README.md)
- [**KalguurRewardElement Methods**](./KalguurRewardElement Methods/README.md)
- [**KalguurRewardElement Fields**](./KalguurRewardElement Fields/README.md)
