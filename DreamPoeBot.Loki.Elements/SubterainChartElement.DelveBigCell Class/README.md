# SubterainChartElement.DelveBigCell Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SubterainChartElement.DelveBigCell"]
...
```csharp
public ref class DelveBigCell : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | SubterainChartElement DelveBigCell | Initializes a new instance of the SubterainChartElement DelveBigCell class |
...
## Дочерние разделы
- [**SubterainChartElement.DelveBigCell Constructor **](./SubterainChartElement.DelveBigCell Constructor/README.md)
- [**DelveBigCell Properties**](./DelveBigCell Properties/README.md)
- [**DelveBigCell Methods**](./DelveBigCell Methods/README.md)
- [**DelveBigCell Fields**](./DelveBigCell Fields/README.md)
