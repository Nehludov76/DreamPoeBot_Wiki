# ArchnemesisPannelInventoryElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ArchnemesisPannelInventoryElement"]
...
```csharp
public ref class ArchnemesisPannelInventoryElement : public Element
```
...
The ArchnemesisPannelInventoryElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ArchnemesisPannelInventoryElement | Initializes a new instance of the ArchnemesisPannelInventoryElement class |
...
## Дочерние разделы
- [**ArchnemesisPannelInventoryElement Constructor **](./ArchnemesisPannelInventoryElement Constructor/README.md)
- [**ArchnemesisPannelInventoryElement Properties**](./ArchnemesisPannelInventoryElement Properties/README.md)
- [**ArchnemesisPannelInventoryElement Methods**](./ArchnemesisPannelInventoryElement Methods/README.md)
- [**ArchnemesisPannelInventoryElement Fields**](./ArchnemesisPannelInventoryElement Fields/README.md)
