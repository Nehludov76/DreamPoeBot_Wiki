...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.RewardElement"]
...
```csharp
public ref class RewardElement : public Element
```
...
The RewardElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | RewardElement | Initializes a new instance of the RewardElement class |
...
## Дочерние разделы
- [**RewardElement Constructor **](./RewardElement Constructor/README.md)
- [**RewardElement Properties**](./RewardElement Properties/README.md)
- [**RewardElement Methods**](./RewardElement Methods/README.md)
- [**RewardElement Fields**](./RewardElement Fields/README.md)
