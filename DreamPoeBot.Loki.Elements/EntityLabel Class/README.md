...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.EntityLabel"]
...
```csharp
public ref class EntityLabel : public Element
```
...
The EntityLabel type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | EntityLabel | Initializes a new instance of the EntityLabel class |
...
## Дочерние разделы
- [**EntityLabel Constructor **](./EntityLabel Constructor/README.md)
- [**EntityLabel Properties**](./EntityLabel Properties/README.md)
- [**EntityLabel Methods**](./EntityLabel Methods/README.md)
- [**EntityLabel Fields**](./EntityLabel Fields/README.md)
