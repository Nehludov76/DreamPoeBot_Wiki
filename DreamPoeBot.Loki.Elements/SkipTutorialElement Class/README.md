...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.SkipTutorialElement"]
...
```csharp
public ref class SkipTutorialElement : public Element
```
...
The SkipTutorialElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | SkipTutorialElement | Initializes a new instance of the SkipTutorialElement class |
...
## Дочерние разделы
- [**SkipTutorialElement Constructor **](./SkipTutorialElement Constructor/README.md)
- [**SkipTutorialElement Properties**](./SkipTutorialElement Properties/README.md)
- [**SkipTutorialElement Methods**](./SkipTutorialElement Methods/README.md)
- [**SkipTutorialElement Fields**](./SkipTutorialElement Fields/README.md)
