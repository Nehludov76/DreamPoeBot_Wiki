...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ItemOnGroundTooltip"]
...
```csharp
public ref class ItemOnGroundTooltip : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | ItemOnGroundTooltip | Initializes a new instance of the ItemOnGroundTooltip class |
...
## Дочерние разделы
- [**ItemOnGroundTooltip Constructor **](./ItemOnGroundTooltip Constructor/README.md)
- [**ItemOnGroundTooltip Properties**](./ItemOnGroundTooltip Properties/README.md)
- [**ItemOnGroundTooltip Methods**](./ItemOnGroundTooltip Methods/README.md)
- [**ItemOnGroundTooltip Fields**](./ItemOnGroundTooltip Fields/README.md)
