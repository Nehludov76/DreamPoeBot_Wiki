...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.CurrencyExchangeElement"]


```csharp
public class CurrencyExchangeElement : Element
```
...
```csharp
public ref class CurrencyExchangeElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | CurrencyExchangeElement | Initializes a new instance of the CurrencyExchangeElement class |
...
|  | CurrencySelectionPannelElement |  |
|  | CurrentRatioElement |  |
...
## Дочерние разделы
- [**CurrencyExchangeElement Constructor **](./CurrencyExchangeElement Constructor/README.md)
- [**CurrencyExchangeElement Properties**](./CurrencyExchangeElement Properties/README.md)
- [**CurrencyExchangeElement Methods**](./CurrencyExchangeElement Methods/README.md)
- [**CurrencyExchangeElement Fields**](./CurrencyExchangeElement Fields/README.md)
