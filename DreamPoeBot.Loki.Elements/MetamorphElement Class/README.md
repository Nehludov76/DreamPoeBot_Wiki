...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MetamorphElement"]
...
```csharp
public ref class MetamorphElement : public Element
```
...
The MetamorphElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MetamorphElement | Initializes a new instance of the MetamorphElement class |
...
## Дочерние разделы
- [**MetamorphElement Constructor **](./MetamorphElement Constructor/README.md)
- [**MetamorphElement Properties**](./MetamorphElement Properties/README.md)
- [**MetamorphElement Methods**](./MetamorphElement Methods/README.md)
- [**MetamorphElement Fields**](./MetamorphElement Fields/README.md)
