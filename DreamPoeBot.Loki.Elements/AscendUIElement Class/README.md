...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AscendUIElement"]
...
```csharp
public ref class AscendUIElement : public Element
```
...
The AscendUIElement type exposes the following members.


| Name | Description |
| --- | --- |
| AscendUIElement | Initializes a new instance of the AscendUIElement class |
