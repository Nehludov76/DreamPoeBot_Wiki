...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PassiveTreeElement"]
...
```csharp
public ref class PassiveTreeElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | PassiveTreeElement | Initializes a new instance of the PassiveTreeElement class |
...
|  | IntPtr_3_AflictionAscendUi |  |
|  | IntPtr_3_AscendUi |  |
|  | IntPtr_IsAflictionAscendUiUnlocked |  |
|  | IntPtr_IsAscendUiUnlocked |  |
|  | IntPtr_MasteryUi |  |
|  | IsApplyEnabled |  |
|  | IsApplyVisible |  |
|  | IsCancelEnabled |  |
...
|  | IsMaxZoomIn |  |
|  | IsMaxZoomOut |  |
|  | IsRefundPassivesEnabled |  |
|  | IsRefundPassivesVisible |  |
|  | IsResetAllPassivesEnabled |  |
|  | IsResetAllPassivesVisible |  |
...
|  | PasDict |  |
|  | RefundPassivesButtonElement |  |
|  | ResetAllPassivesElement |  |
...
## Дочерние разделы
- [**PassiveTreeElement Constructor **](./PassiveTreeElement Constructor/README.md)
- [**PassiveTreeElement Properties**](./PassiveTreeElement Properties/README.md)
- [**PassiveTreeElement Methods**](./PassiveTreeElement Methods/README.md)
- [**PassiveTreeElement Fields**](./PassiveTreeElement Fields/README.md)
