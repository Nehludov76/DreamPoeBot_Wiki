...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.DelveUiElement"]
...
```csharp
public ref class DelveUiElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | DelveUiElement | Initializes a new instance of the DelveUiElement class |
...
## Дочерние разделы
- [**DelveUiElement Constructor **](./DelveUiElement Constructor/README.md)
- [**DelveUiElement Properties**](./DelveUiElement Properties/README.md)
- [**DelveUiElement Methods**](./DelveUiElement Methods/README.md)
- [**DelveUiElement Fields**](./DelveUiElement Fields/README.md)
