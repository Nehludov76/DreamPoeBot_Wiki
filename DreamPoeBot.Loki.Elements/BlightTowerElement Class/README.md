...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BlightTowerElement"]
...
```csharp
public ref class BlightTowerElement : public Element
```
...
The BlightTowerElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BlightTowerElement | Initializes a new instance of the BlightTowerElement class |
...
## Дочерние разделы
- [**BlightTowerElement Constructor **](./BlightTowerElement Constructor/README.md)
- [**BlightTowerElement Properties**](./BlightTowerElement Properties/README.md)
- [**BlightTowerElement Methods**](./BlightTowerElement Methods/README.md)
- [**BlightTowerElement Fields**](./BlightTowerElement Fields/README.md)
