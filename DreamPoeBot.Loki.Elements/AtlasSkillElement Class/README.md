...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.AtlasSkillElement"]
...
```csharp
public ref class AtlasSkillElement : public Element
```
...
The AtlasSkillElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | AtlasSkillElement | Initializes a new instance of the AtlasSkillElement class |
...
|  | PasDict |  |
|  | RefoundPassiveButton |  |
|  | ResetAllPassiveButton |  |
...
## Дочерние разделы
- [**AtlasSkillElement Constructor **](./AtlasSkillElement Constructor/README.md)
- [**AtlasSkillElement Properties**](./AtlasSkillElement Properties/README.md)
- [**AtlasSkillElement Methods**](./AtlasSkillElement Methods/README.md)
- [**AtlasSkillElement Fields**](./AtlasSkillElement Fields/README.md)
