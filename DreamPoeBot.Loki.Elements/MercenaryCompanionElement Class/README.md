# MercenaryCompanionElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MercenaryCompanionElement"]


```csharp
public class MercenaryCompanionElement : Element
```
...
```csharp
public ref class MercenaryCompanionElement : public Element
```
...
The MercenaryCompanionElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MercenaryCompanionElement | Initializes a new instance of the MercenaryCompanionElement class |
...
## Дочерние разделы
- [**MercenaryCompanionElement Constructor **](./MercenaryCompanionElement Constructor/README.md)
- [**MercenaryCompanionElement Properties**](./MercenaryCompanionElement Properties/README.md)
- [**MercenaryCompanionElement Methods**](./MercenaryCompanionElement Methods/README.md)
- [**MercenaryCompanionElement Fields**](./MercenaryCompanionElement Fields/README.md)
