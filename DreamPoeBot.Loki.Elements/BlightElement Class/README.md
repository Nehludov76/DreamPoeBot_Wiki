...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.BlightElement"]
...
```csharp
public ref class BlightElement : public Element
```
...
The BlightElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BlightElement | Initializes a new instance of the BlightElement class |
...
## Дочерние разделы
- [**BlightElement Constructor **](./BlightElement Constructor/README.md)
- [**BlightElement Properties**](./BlightElement Properties/README.md)
- [**BlightElement Methods**](./BlightElement Methods/README.md)
- [**BlightElement Fields**](./BlightElement Fields/README.md)
