...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.HeistAlertLevelElement"]
...
```csharp
public ref class HeistAlertLevelElement : public Element
```
...
The HeistAlertLevelElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HeistAlertLevelElement | Initializes a new instance of the HeistAlertLevelElement class |
...
|  | IsEscapeTheFacilityVisible |  |
|  | IsImminentLockdownVisible |  |
...
## Дочерние разделы
- [**HeistAlertLevelElement Constructor **](./HeistAlertLevelElement Constructor/README.md)
- [**HeistAlertLevelElement Properties**](./HeistAlertLevelElement Properties/README.md)
- [**HeistAlertLevelElement Methods**](./HeistAlertLevelElement Methods/README.md)
- [**HeistAlertLevelElement Fields**](./HeistAlertLevelElement Fields/README.md)
