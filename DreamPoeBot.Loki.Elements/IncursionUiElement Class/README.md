...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.IncursionUiElement"]
...
```csharp
public ref class IncursionUiElement : public Element
```
...
The IncursionUiElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | IncursionUiElement | Initializes a new instance of the IncursionUiElement class |
...
|  | OpenTempleElement |  |
|  | OpenTempleElementClickLocation |  |
|  | Parent | (Inherited from Element .) |
|  | Root | (Inherited from Element .) |
|  | Scale | (Inherited from Element .) |
|  | TakeTempleChronicleElement |  |
|  | TakeTempleChronicleElementClickLocation |  |
...
## Дочерние разделы
- [**IncursionUiElement Constructor **](./IncursionUiElement Constructor/README.md)
- [**IncursionUiElement Properties**](./IncursionUiElement Properties/README.md)
- [**IncursionUiElement Methods**](./IncursionUiElement Methods/README.md)
- [**IncursionUiElement Fields**](./IncursionUiElement Fields/README.md)
