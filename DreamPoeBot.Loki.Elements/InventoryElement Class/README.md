...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElement"]
...
```csharp
public ref class InventoryElement : public Element
```
...
The InventoryElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | InventoryElement | Initializes a new instance of the InventoryElement class |
...
## Дочерние разделы
- [**InventoryElement Constructor **](./InventoryElement Constructor/README.md)
- [**InventoryElement Properties**](./InventoryElement Properties/README.md)
- [**InventoryElement Methods**](./InventoryElement Methods/README.md)
- [**InventoryElement Fields**](./InventoryElement Fields/README.md)
