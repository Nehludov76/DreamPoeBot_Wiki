# PassiveTreeElement.MasteryUiElemet Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PassiveTreeElement.MasteryUiElemet"]
...
```csharp
public ref class MasteryUiElemet : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | PassiveTreeElement MasteryUiElemet | Initializes a new instance of the PassiveTreeElement MasteryUiElemet class |
...
## Дочерние разделы
- [**PassiveTreeElement.MasteryUiElemet Constructor **](./PassiveTreeElement.MasteryUiElemet Constructor/README.md)
- [**MasteryUiElemet Properties**](./MasteryUiElemet Properties/README.md)
- [**MasteryUiElemet Methods**](./MasteryUiElemet Methods/README.md)
- [**MasteryUiElemet Fields**](./MasteryUiElemet Fields/README.md)
