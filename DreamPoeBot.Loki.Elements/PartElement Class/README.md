...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PartElement"]
...
```csharp
public ref class PartElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | PartElement | Initializes a new instance of the PartElement class |
...
## Дочерние разделы
- [**PartElement Constructor **](./PartElement Constructor/README.md)
- [**PartElement Properties**](./PartElement Properties/README.md)
- [**PartElement Methods**](./PartElement Methods/README.md)
- [**PartElement Fields**](./PartElement Fields/README.md)
