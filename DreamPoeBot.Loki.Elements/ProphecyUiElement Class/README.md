...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ProphecyUiElement"]
...
```csharp
public ref class ProphecyUiElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | ProphecyUiElement | Initializes a new instance of the ProphecyUiElement class |
...
## Дочерние разделы
- [**ProphecyUiElement Constructor **](./ProphecyUiElement Constructor/README.md)
- [**ProphecyUiElement Properties**](./ProphecyUiElement Properties/README.md)
- [**ProphecyUiElement Methods**](./ProphecyUiElement Methods/README.md)
- [**ProphecyUiElement Fields**](./ProphecyUiElement Fields/README.md)
