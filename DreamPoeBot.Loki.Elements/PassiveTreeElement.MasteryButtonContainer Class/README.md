# PassiveTreeElement.MasteryButtonContainer Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.PassiveTreeElement.MasteryButtonContainer"]
...
```csharp
public ref class MasteryButtonContainer : public Element
```
...
The PassiveTreeElement MasteryButtonContainer type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PassiveTreeElement MasteryButtonContainer | Initializes a new instance of the PassiveTreeElement MasteryButtonContainer class |
...
|  | MasteryButtonCenterClickLocation |  |
...
## Дочерние разделы
- [**PassiveTreeElement.MasteryButtonContainer Constructor **](./PassiveTreeElement.MasteryButtonContainer Constructor/README.md)
- [**MasteryButtonContainer Properties**](./MasteryButtonContainer Properties/README.md)
- [**MasteryButtonContainer Methods**](./MasteryButtonContainer Methods/README.md)
- [**MasteryButtonContainer Fields**](./MasteryButtonContainer Fields/README.md)
