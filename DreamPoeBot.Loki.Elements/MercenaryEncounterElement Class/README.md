# MercenaryEncounterElement Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.MercenaryEncounterElement"]


```csharp
public class MercenaryEncounterElement : Element
```
...
```csharp
public ref class MercenaryEncounterElement : public Element
```
...
The MercenaryEncounterElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MercenaryEncounterElement | Initializes a new instance of the MercenaryEncounterElement class |
...
## Дочерние разделы
- [**MercenaryEncounterElement Constructor **](./MercenaryEncounterElement Constructor/README.md)
- [**MercenaryEncounterElement Properties**](./MercenaryEncounterElement Properties/README.md)
- [**MercenaryEncounterElement Methods**](./MercenaryEncounterElement Methods/README.md)
- [**MercenaryEncounterElement Fields**](./MercenaryEncounterElement Fields/README.md)
