...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.ChallengesPannelElement"]
...
```csharp
public ref class ChallengesPannelElement : public Element
```
...
The ChallengesPannelElement type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ChallengesPannelElement | Initializes a new instance of the ChallengesPannelElement class |
...
## Дочерние разделы
- [**ChallengesPannelElement Constructor **](./ChallengesPannelElement Constructor/README.md)
- [**ChallengesPannelElement Properties**](./ChallengesPannelElement Properties/README.md)
- [**ChallengesPannelElement Methods**](./ChallengesPannelElement Methods/README.md)
- [**ChallengesPannelElement Fields**](./ChallengesPannelElement Fields/README.md)
