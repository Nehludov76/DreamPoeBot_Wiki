...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Bot.IRoutine"]


```csharp
public interface IRoutine : IConfigurable , IMessageHandler , IStartStopEvents , ITickEvents , IAuthored , IBase , ILogicProvider
```
...
```csharp
public interface class IRoutine : IConfigurable , IMessageHandler , IStartStopEvents , ITickEvents , IAuthored , IBase , ILogicProvider
```
