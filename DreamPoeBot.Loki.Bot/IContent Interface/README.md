...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Bot.IContent"]


```csharp
public interface IContent : IConfigurable , IMessageHandler , IAuthored , IBase , ILogicProvider
```
...
```csharp
public interface class IContent : IConfigurable , IMessageHandler , IAuthored , IBase , ILogicProvider
```
