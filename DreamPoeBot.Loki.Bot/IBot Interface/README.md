...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Bot.IBot"]


```csharp
public interface IBot : IConfigurable , IMessageHandler , IStartStopEvents , ITickEvents , IAuthored , IBase , ILogicProvider
```
...
```csharp
public interface class IBot : IConfigurable , IMessageHandler , IStartStopEvents , ITickEvents , IAuthored , IBase , ILogicProvider
```
