...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Bot.Coroutines"]
...
```csharp
public ref class Coroutines abstract sealed
```
...
## Дочерние разделы
- [**Coroutines Properties**](./Coroutines Properties/README.md)
- [**Coroutines Methods**](./Coroutines Methods/README.md)
