...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Bot.IPlayerMover"]


```csharp
public interface IPlayerMover : IConfigurable , IStartStopEvents , ITickEvents , IBase , IAuthored , ILogicProvider , IMessageHandler
```
...
```csharp
public interface class IPlayerMover : IConfigurable , IStartStopEvents , ITickEvents , IBase , IAuthored , ILogicProvider , IMessageHandler
```
