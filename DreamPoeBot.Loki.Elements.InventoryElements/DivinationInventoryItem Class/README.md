...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.DivinationInventoryItem"]
...
```csharp
public ref class DivinationInventoryItem : public NormalInventoryItem
```
...
| Name | Description |
| --- | --- |
| DivinationInventoryItem | Initializes a new instance of the DivinationInventoryItem class |
