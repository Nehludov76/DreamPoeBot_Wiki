...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.MapStashTabElement"]
...
```csharp
public ref class MapStashTabElement : public Element
```
...
|  | Name | Description |
| --- | --- | --- |
|  | MapStashTabElement | Initializes a new instance of the MapStashTabElement class |
...
## Дочерние разделы
- [**MapStashTabElement Constructor **](./MapStashTabElement Constructor/README.md)
- [**MapStashTabElement Properties**](./MapStashTabElement Properties/README.md)
- [**MapStashTabElement Methods**](./MapStashTabElement Methods/README.md)
- [**MapStashTabElement Fields**](./MapStashTabElement Fields/README.md)
