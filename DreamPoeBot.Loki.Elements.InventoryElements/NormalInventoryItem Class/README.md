...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.NormalInventoryItem"]
...
```csharp
public ref class NormalInventoryItem : public Element
```
...
| Name | Description |
| --- | --- |
| NormalInventoryItem | Initializes a new instance of the NormalInventoryItem class |
