...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.EssenceInventoryItem"]
...
```csharp
public ref class EssenceInventoryItem : public NormalInventoryItem
```
...
The EssenceInventoryItem type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | EssenceInventoryItem | Initializes a new instance of the EssenceInventoryItem class |
...
## Дочерние разделы
- [**EssenceInventoryItem Constructor **](./EssenceInventoryItem Constructor/README.md)
- [**EssenceInventoryItem Properties**](./EssenceInventoryItem Properties/README.md)
- [**EssenceInventoryItem Methods**](./EssenceInventoryItem Methods/README.md)
- [**EssenceInventoryItem Fields**](./EssenceInventoryItem Fields/README.md)
