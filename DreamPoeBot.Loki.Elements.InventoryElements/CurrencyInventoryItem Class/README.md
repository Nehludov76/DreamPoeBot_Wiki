...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.CurrencyInventoryItem"]
...
```csharp
public ref class CurrencyInventoryItem : public NormalInventoryItem
```
...
The CurrencyInventoryItem type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CurrencyInventoryItem | Initializes a new instance of the CurrencyInventoryItem class |
...
## Дочерние разделы
- [**CurrencyInventoryItem Constructor **](./CurrencyInventoryItem Constructor/README.md)
- [**CurrencyInventoryItem Properties**](./CurrencyInventoryItem Properties/README.md)
- [**CurrencyInventoryItem Methods**](./CurrencyInventoryItem Methods/README.md)
- [**CurrencyInventoryItem Fields**](./CurrencyInventoryItem Fields/README.md)
