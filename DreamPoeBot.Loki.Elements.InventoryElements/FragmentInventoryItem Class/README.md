...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Elements.InventoryElements.FragmentInventoryItem"]
...
```csharp
public ref class FragmentInventoryItem : public NormalInventoryItem
```
...
The FragmentInventoryItem type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | FragmentInventoryItem | Initializes a new instance of the FragmentInventoryItem class |
...
|  | InnerItem | (Inherited from NormalInventoryItem .) |
|  | InventPosX | (Overrides NormalInventoryItem InventPosX .) |
|  | InventPosY | (Overrides NormalInventoryItem InventPosY .) |
...
|  | LocalId | (Inherited from NormalInventoryItem .) |
|  | LocationBottomRight | (Inherited from NormalInventoryItem .) |
|  | LocationTopLeft | (Inherited from NormalInventoryItem .) |
...
|  | StaskSize | (Inherited from NormalInventoryItem .) |
|  | Text | (Inherited from Element .) |
|  | Tooltip | (Inherited from Element .) |
|  | ToolTip | (Inherited from NormalInventoryItem .) |
...
|  | GetClientRect | (Overrides Element GetClientRect .) |
...
## Дочерние разделы
- [**FragmentInventoryItem Constructor **](./FragmentInventoryItem Constructor/README.md)
- [**FragmentInventoryItem Properties**](./FragmentInventoryItem Properties/README.md)
- [**FragmentInventoryItem Methods**](./FragmentInventoryItem Methods/README.md)
- [**FragmentInventoryItem Fields**](./FragmentInventoryItem Fields/README.md)
