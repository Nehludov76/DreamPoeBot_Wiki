...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.InventoryVisual"]
...
```csharp
public ref class InventoryVisual : public RemoteMemoryObject
```
...
The InventoryVisual type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | InventoryVisual | Initializes a new instance of the InventoryVisual class |
...
## Дочерние разделы
- [**InventoryVisual Constructor **](./InventoryVisual Constructor/README.md)
- [**InventoryVisual Properties**](./InventoryVisual Properties/README.md)
- [**InventoryVisual Methods**](./InventoryVisual Methods/README.md)
- [**InventoryVisual Fields**](./InventoryVisual Fields/README.md)
