...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.MapKey"]
...
```csharp
public ref class MapKey : public Component
```
...
The MapKey type exposes the following members.
...
## Дочерние разделы
- [**MapKey Constructor **](./MapKey Constructor/README.md)
- [**MapKey Properties**](./MapKey Properties/README.md)
- [**MapKey Methods**](./MapKey Methods/README.md)
- [**MapKey Fields**](./MapKey Fields/README.md)
