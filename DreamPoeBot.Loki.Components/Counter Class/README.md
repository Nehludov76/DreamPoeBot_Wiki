...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Counter"]
...
```csharp
public ref class Counter : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Counter | Initializes a new instance of the Counter class |
...
## Дочерние разделы
- [**Counter Constructor **](./Counter Constructor/README.md)
- [**Counter Properties**](./Counter Properties/README.md)
- [**Counter Methods**](./Counter Methods/README.md)
- [**Counter Fields**](./Counter Fields/README.md)
