...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Render"]
...
```csharp
public ref class Render : public Component
```
...
| Name | Description |
| --- | --- |
| Render | Initializes a new instance of the Render class |
