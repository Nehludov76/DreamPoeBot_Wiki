...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Shield"]
...
```csharp
public ref class Shield : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Shield | Initializes a new instance of the Shield class |
...
## Дочерние разделы
- [**Shield Constructor **](./Shield Constructor/README.md)
- [**Shield Properties**](./Shield Properties/README.md)
- [**Shield Methods**](./Shield Methods/README.md)
- [**Shield Fields**](./Shield Fields/README.md)
