...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Stats"]
...
```csharp
public ref class Stats : public Component
```
...
## Дочерние разделы
- [**Stats Constructor **](./Stats Constructor/README.md)
- [**Stats Properties**](./Stats Properties/README.md)
- [**Stats Methods**](./Stats Methods/README.md)
- [**Stats Fields**](./Stats Fields/README.md)
