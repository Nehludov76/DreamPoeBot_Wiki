...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Prophecy"]
...
```csharp
public ref class Prophecy : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Prophecy | Initializes a new instance of the Prophecy class |
...
## Дочерние разделы
- [**Prophecy Constructor **](./Prophecy Constructor/README.md)
- [**Prophecy Properties**](./Prophecy Properties/README.md)
- [**Prophecy Methods**](./Prophecy Methods/README.md)
- [**Prophecy Fields**](./Prophecy Fields/README.md)
