...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.ProximityTrigger"]
...
```csharp
public ref class ProximityTrigger : public Component
```
...
The ProximityTrigger type exposes the following members.


| Name | Description |
| --- | --- |
| ProximityTrigger | Initializes a new instance of the ProximityTrigger class |
