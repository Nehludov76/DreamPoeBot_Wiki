...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Flask"]
...
```csharp
public ref class Flask : public Component
```
...
| Name | Description |
| --- | --- |
| Flask | Initializes a new instance of the Flask class |
