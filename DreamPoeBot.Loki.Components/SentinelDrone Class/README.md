...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.SentinelDrone"]
...
```csharp
public ref class SentinelDrone : public Component
```
...
The SentinelDrone type exposes the following members.


| Name | Description |
| --- | --- |
| SentinelDrone | Initializes a new instance of the SentinelDrone class |
