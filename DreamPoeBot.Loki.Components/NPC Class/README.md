...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.NPC"]
...
```csharp
public ref class NPC : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | NPC | Initializes a new instance of the NPC class |
...
## Дочерние разделы
- [**NPC Constructor **](./NPC Constructor/README.md)
- [**NPC Properties**](./NPC Properties/README.md)
- [**NPC Methods**](./NPC Methods/README.md)
- [**NPC Fields**](./NPC Fields/README.md)
