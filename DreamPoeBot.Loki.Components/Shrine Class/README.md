...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Shrine"]
...
```csharp
public ref class Shrine : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Shrine | Initializes a new instance of the Shrine class |
...
## Дочерние разделы
- [**Shrine Constructor **](./Shrine Constructor/README.md)
- [**Shrine Properties**](./Shrine Properties/README.md)
- [**Shrine Methods**](./Shrine Methods/README.md)
- [**Shrine Fields**](./Shrine Fields/README.md)
