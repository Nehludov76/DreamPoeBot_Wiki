...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Targetable"]
...
```csharp
public ref class Targetable : public Component
```
...
The Targetable type exposes the following members.


| Name | Description |
| --- | --- |
| Targetable | Initializes a new instance of the Targetable class |
