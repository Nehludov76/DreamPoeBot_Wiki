...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.CapturedMonster"]
...
```csharp
public ref class CapturedMonster : public Component
```
...
| Name | Description |
| --- | --- |
| CapturedMonster | Initializes a new instance of the CapturedMonster class |
