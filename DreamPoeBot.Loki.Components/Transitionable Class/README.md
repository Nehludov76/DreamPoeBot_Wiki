...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Transitionable"]
...
```csharp
public ref class Transitionable : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Transitionable | Initializes a new instance of the Transitionable class |
...
## Дочерние разделы
- [**Transitionable Constructor **](./Transitionable Constructor/README.md)
- [**Transitionable Properties**](./Transitionable Properties/README.md)
- [**Transitionable Methods**](./Transitionable Methods/README.md)
- [**Transitionable Fields**](./Transitionable Fields/README.md)
