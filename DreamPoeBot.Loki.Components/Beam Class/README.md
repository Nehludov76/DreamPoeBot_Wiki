...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Beam"]
...
```csharp
public ref class Beam : public Component
```
...
## Дочерние разделы
- [**Beam Constructor **](./Beam Constructor/README.md)
- [**Beam Properties**](./Beam Properties/README.md)
- [**Beam Methods**](./Beam Methods/README.md)
- [**Beam Fields**](./Beam Fields/README.md)
