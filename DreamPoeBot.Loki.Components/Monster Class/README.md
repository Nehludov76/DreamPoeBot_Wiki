...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Monster"]
...
```csharp
public ref class Monster : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Monster | Initializes a new instance of the Monster class |
...
## Дочерние разделы
- [**Monster Constructor **](./Monster Constructor/README.md)
- [**Monster Properties**](./Monster Properties/README.md)
- [**Monster Methods**](./Monster Methods/README.md)
- [**Monster Fields**](./Monster Fields/README.md)
