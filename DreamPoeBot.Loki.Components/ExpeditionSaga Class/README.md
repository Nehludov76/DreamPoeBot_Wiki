...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.ExpeditionSaga"]
...
```csharp
public ref class ExpeditionSaga : public Component
```
...
The ExpeditionSaga type exposes the following members.


| Name | Description |
| --- | --- |
| ExpeditionSaga | Initializes a new instance of the ExpeditionSaga class |
