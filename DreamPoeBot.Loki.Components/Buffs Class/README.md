...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Buffs"]
...
```csharp
public ref class Buffs : public Component
```
...
The Buffs type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | Buffs | Initializes a new instance of the Buffs class |
...
## Дочерние разделы
- [**Buffs Constructor **](./Buffs Constructor/README.md)
- [**Buffs Properties**](./Buffs Properties/README.md)
- [**Buffs Methods**](./Buffs Methods/README.md)
- [**Buffs Fields**](./Buffs Fields/README.md)
