...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Actor.ActionWrapper"]
...
```csharp
public ref class ActionWrapper : public RemoteMemoryObject
```
...
## Дочерние разделы
- [**ActionWrapper Properties**](./ActionWrapper Properties/README.md)
- [**ActionWrapper Methods**](./ActionWrapper Methods/README.md)
- [**ActionWrapper Fields**](./ActionWrapper Fields/README.md)
