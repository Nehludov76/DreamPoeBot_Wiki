...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Armour"]
...
```csharp
public ref class Armour : public Component
```
...
The Armour type exposes the following members.


| Name | Description |
| --- | --- |
| Armour | Initializes a new instance of the Armour class |
