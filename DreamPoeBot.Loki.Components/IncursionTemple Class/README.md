...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.IncursionTemple"]
...
```csharp
public ref class IncursionTemple : public Component
```
...
| Name | Description |
| --- | --- |
| IncursionTemple | Initializes a new instance of the IncursionTemple class |
