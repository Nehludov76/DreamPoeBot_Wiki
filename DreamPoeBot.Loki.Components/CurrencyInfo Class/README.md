...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.CurrencyInfo"]
...
```csharp
public ref class CurrencyInfo : public Component
```
...
| Name | Description |
| --- | --- |
| CurrencyInfo | Initializes a new instance of the CurrencyInfo class |
