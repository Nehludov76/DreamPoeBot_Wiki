...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.LocalStats"]
...
```csharp
public ref class LocalStats : public Component
```
...
The LocalStats type exposes the following members.


| Name | Description |
| --- | --- |
| LocalStats | Initializes a new instance of the LocalStats class |
| LocalStats(Int64) | Initializes a new instance of the LocalStats class |
