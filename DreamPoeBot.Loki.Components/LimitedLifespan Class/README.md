...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.LimitedLifespan"]
...
```csharp
public ref class LimitedLifespan : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | LimitedLifespan | Initializes a new instance of the LimitedLifespan class |
...
## Дочерние разделы
- [**LimitedLifespan Constructor **](./LimitedLifespan Constructor/README.md)
- [**LimitedLifespan Properties**](./LimitedLifespan Properties/README.md)
- [**LimitedLifespan Methods**](./LimitedLifespan Methods/README.md)
- [**LimitedLifespan Fields**](./LimitedLifespan Fields/README.md)
