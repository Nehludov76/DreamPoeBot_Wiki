...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Magnetic"]
...
```csharp
public ref class Magnetic : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Magnetic | Initializes a new instance of the Magnetic class |
...
## Дочерние разделы
- [**Magnetic Constructor **](./Magnetic Constructor/README.md)
- [**Magnetic Properties**](./Magnetic Properties/README.md)
- [**Magnetic Methods**](./Magnetic Methods/README.md)
- [**Magnetic Fields**](./Magnetic Fields/README.md)
