...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Projectile"]
...
```csharp
public ref class Projectile : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Projectile | Initializes a new instance of the Projectile class |
...
## Дочерние разделы
- [**Projectile Constructor **](./Projectile Constructor/README.md)
- [**Projectile Properties**](./Projectile Properties/README.md)
- [**Projectile Methods**](./Projectile Methods/README.md)
- [**Projectile Fields**](./Projectile Fields/README.md)
