...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.WorldDescription"]
...
```csharp
public ref class WorldDescription : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | WorldDescription | Initializes a new instance of the WorldDescription class |
...
## Дочерние разделы
- [**WorldDescription Constructor **](./WorldDescription Constructor/README.md)
- [**WorldDescription Properties**](./WorldDescription Properties/README.md)
- [**WorldDescription Methods**](./WorldDescription Methods/README.md)
- [**WorldDescription Fields**](./WorldDescription Fields/README.md)
