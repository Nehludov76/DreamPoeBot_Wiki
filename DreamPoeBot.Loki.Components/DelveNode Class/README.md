...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.DelveNode"]


```csharp
public class DelveNode : Component
```
...
```csharp
public ref class DelveNode : public Component
```
...
The DelveNode type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | DelveNode | Initializes a new instance of the DelveNode class |
...
## Дочерние разделы
- [**DelveNode Constructor **](./DelveNode Constructor/README.md)
