...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.BaseEvents"]
...
```csharp
public ref class BaseEvents : public Component
```
...
The BaseEvents type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BaseEvents | Initializes a new instance of the BaseEvents class |
...
## Дочерние разделы
- [**BaseEvents Constructor **](./BaseEvents Constructor/README.md)
- [**BaseEvents Properties**](./BaseEvents Properties/README.md)
- [**BaseEvents Methods**](./BaseEvents Methods/README.md)
- [**BaseEvents Fields**](./BaseEvents Fields/README.md)
