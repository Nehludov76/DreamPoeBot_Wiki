...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Tincture"]
...
```csharp
public ref class Tincture : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Tincture | Initializes a new instance of the Tincture class |


|  | Name | Description |
| --- | --- | --- |
|  | Address | (Inherited from RemoteMemoryObject .) |
|  | BaseManaburnMsTick | The base milliseconds between tick of Manaburn. Pls note, stats on the item might modify it. |
|  | BaseMsCooldown | The base milliseconds cooldown after deactivation. Pls note, stats on the item might modify it. |
...
## Дочерние разделы
- [**Tincture Constructor **](./Tincture Constructor/README.md)
- [**Tincture Properties**](./Tincture Properties/README.md)
- [**Tincture Methods**](./Tincture Methods/README.md)
- [**Tincture Fields**](./Tincture Fields/README.md)
