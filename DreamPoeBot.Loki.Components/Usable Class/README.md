...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Usable"]
...
```csharp
public ref class Usable : public Component
```
...
The Usable type exposes the following members.


| Name | Description |
| --- | --- |
| Usable | Initializes a new instance of the Usable class |
