...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Pointer"]


```csharp
public class Pointer : Component
```
...
```csharp
public ref class Pointer : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Pointer | Initializes a new instance of the Pointer class |
...
## Дочерние разделы
- [**Pointer Constructor **](./Pointer Constructor/README.md)
- [**Pointer Properties**](./Pointer Properties/README.md)
- [**Pointer Methods**](./Pointer Methods/README.md)
- [**Pointer Fields**](./Pointer Fields/README.md)
