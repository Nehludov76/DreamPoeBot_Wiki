...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.HeistContract"]
...
```csharp
public ref class HeistContract : public Component
```
...
| Name | Description |
| --- | --- |
| HeistContract | Initializes a new instance of the HeistContract class |
