...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.DiesAfterTime"]
...
```csharp
public ref class DiesAfterTime : public Component
```
...
| Name | Description |
| --- | --- |
| DiesAfterTime | Initializes a new instance of the DiesAfterTime class |
