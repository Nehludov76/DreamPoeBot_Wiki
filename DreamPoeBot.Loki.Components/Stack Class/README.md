...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Stack"]
...
```csharp
public ref class Stack : public Component
```
...
## Дочерние разделы
- [**Stack Constructor **](./Stack Constructor/README.md)
- [**Stack Properties**](./Stack Properties/README.md)
- [**Stack Methods**](./Stack Methods/README.md)
- [**Stack Fields**](./Stack Fields/README.md)
