...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Animated"]
...
```csharp
public ref class Animated : public Component
```
...
The Animated type exposes the following members.


| Name | Description |
| --- | --- |
| Animated | Initializes a new instance of the Animated class |
