...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.HeistRewardDisplay"]
...
```csharp
public ref class HeistRewardDisplay : public Component
```
...
The HeistRewardDisplay type exposes the following members.


| Name | Description |
| --- | --- |
| HeistRewardDisplay | Initializes a new instance of the HeistRewardDisplay class |
