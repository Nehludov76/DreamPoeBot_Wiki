...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Hull"]
...
```csharp
public ref class Hull : public Component
```
...
| Name | Description |
| --- | --- |
| Hull | Initializes a new instance of the Hull class |
