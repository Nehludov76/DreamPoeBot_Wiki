...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.BreachObject"]
...
```csharp
public ref class BreachObject : public Component
```
...
| Name | Description |
| --- | --- |
| BreachObject | Initializes a new instance of the BreachObject class |
