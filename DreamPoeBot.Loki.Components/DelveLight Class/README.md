...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.DelveLight"]
...
```csharp
public ref class DelveLight : public Component
```
...
The DelveLight type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | DelveLight | Initializes a new instance of the DelveLight class |
...
## Дочерние разделы
- [**DelveLight Constructor **](./DelveLight Constructor/README.md)
- [**DelveLight Properties**](./DelveLight Properties/README.md)
- [**DelveLight Methods**](./DelveLight Methods/README.md)
- [**DelveLight Fields**](./DelveLight Fields/README.md)
