...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.ArchnemesisMod"]
...
```csharp
public ref class ArchnemesisMod : public Component
```
...
| Name | Description |
| --- | --- |
| ArchnemesisMod | Initializes a new instance of the ArchnemesisMod class |
