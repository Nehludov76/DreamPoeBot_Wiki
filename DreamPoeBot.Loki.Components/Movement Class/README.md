...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Movement"]
...
```csharp
public ref class Movement : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Movement | Initializes a new instance of the Movement class |
...
## Дочерние разделы
- [**Movement Constructor **](./Movement Constructor/README.md)
- [**Movement Properties**](./Movement Properties/README.md)
- [**Movement Methods**](./Movement Methods/README.md)
- [**Movement Fields**](./Movement Fields/README.md)
