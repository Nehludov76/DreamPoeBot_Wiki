...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.MinimapIcon"]
...
```csharp
public ref class MinimapIcon : public Component
```
...
The MinimapIcon type exposes the following members.


| Name | Description |
| --- | --- |
| MinimapIcon | Initializes a new instance of the MinimapIcon class |
