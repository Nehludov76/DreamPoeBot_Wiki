...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.BlightTower"]
...
```csharp
public ref class BlightTower : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | BlightTower | Initializes a new instance of the BlightTower class |
...
## Дочерние разделы
- [**BlightTower Constructor **](./BlightTower Constructor/README.md)
- [**BlightTower Properties**](./BlightTower Properties/README.md)
- [**BlightTower Methods**](./BlightTower Methods/README.md)
- [**BlightTower Fields**](./BlightTower Fields/README.md)
