...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.Weapon"]
...
```csharp
public ref class Weapon : public Component
```
...
| Name | Description |
| --- | --- |
| Weapon | Initializes a new instance of the Weapon class |
...
| BaseAttacksPerSecondRaw |
| BaseCritialStrikeChance |
| BaseCritialStrikeChanceRaw |
