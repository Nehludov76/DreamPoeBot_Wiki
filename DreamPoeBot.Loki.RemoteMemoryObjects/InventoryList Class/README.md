...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.InventoryList"]
...
```csharp
public ref class InventoryList : public RemoteMemoryObject
```
...
The InventoryList type exposes the following members.


| Name | Description |
| --- | --- |
| InventoryList | Initializes a new instance of the InventoryList class |
