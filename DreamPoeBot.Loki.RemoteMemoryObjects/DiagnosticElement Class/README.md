...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.DiagnosticElement"]
...
```csharp
public ref class DiagnosticElement : public RemoteMemoryObject
```
...
| Name | Description |
| --- | --- |
| DiagnosticElement | Initializes a new instance of the DiagnosticElement class |
