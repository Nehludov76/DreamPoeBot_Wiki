...
```csharp
public ref class TheGame : public RemoteMemoryObject
```
...
|  | Name | Description |
| --- | --- | --- |
|  | TheGame | Initializes a new instance of the TheGame class |
...
## Дочерние разделы
- [**TheGame Constructor **](./TheGame Constructor/README.md)
- [**TheGame Properties**](./TheGame Properties/README.md)
- [**TheGame Methods**](./TheGame Methods/README.md)
- [**TheGame Fields**](./TheGame Fields/README.md)
