...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.QuestState"]
...
```csharp
public ref class QuestState : public RemoteMemoryObject
```
...
| Name | Description |
| --- | --- |
| QuestState | Initializes a new instance of the QuestState class |
