...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.HideoutWrapper"]
...
```csharp
public ref class HideoutWrapper : public RemoteMemoryObject
```
...
The HideoutWrapper type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HideoutWrapper | Initializes a new instance of the HideoutWrapper class |
...
## Дочерние разделы
- [**HideoutWrapper Constructor **](./HideoutWrapper Constructor/README.md)
- [**HideoutWrapper Properties**](./HideoutWrapper Properties/README.md)
- [**HideoutWrapper Methods**](./HideoutWrapper Methods/README.md)
- [**HideoutWrapper Fields**](./HideoutWrapper Fields/README.md)
