...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.NativeStringReader"]
...
```csharp
public ref class NativeStringReader : public RemoteMemoryObject
```
...
| Name | Description |
| --- | --- |
| NativeStringReader | Initializes a new instance of the NativeStringReader class |
