# IngameUIElements Class

**Вложено элементов:** 152  
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.IngameUIElements"]
...
```csharp
public ref class IngameUIElements : public RemoteMemoryObject
```
...
|  | Name | Description |
| --- | --- | --- |
|  | IngameUIElements | Initializes a new instance of the IngameUIElements class |
...
## Дочерние разделы
- [**IngameUIElements Constructor **](./IngameUIElements Constructor/README.md)
- [**IngameUIElements Properties**](./IngameUIElements Properties/README.md)
- [**IngameUIElements Methods**](./IngameUIElements Methods/README.md)
- [**IngameUIElements Fields**](./IngameUIElements Fields/README.md)
