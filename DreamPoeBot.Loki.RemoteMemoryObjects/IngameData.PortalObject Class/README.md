...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.IngameData.PortalObject"]
...
```csharp
public ref class PortalObject : public RemoteMemoryObject
```
...
| Name | Description |
| --- | --- |
| IngameData PortalObject | Initializes a new instance of the IngameData PortalObject class |
