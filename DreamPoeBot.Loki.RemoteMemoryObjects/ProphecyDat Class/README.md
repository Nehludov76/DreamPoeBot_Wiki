...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.RemoteMemoryObjects.ProphecyDat"]
...
```csharp
public ref class ProphecyDat : public RemoteMemoryObject
```
...
The ProphecyDat type exposes the following members.


| Name | Description |
| --- | --- |
| ProphecyDat | Initializes a new instance of the ProphecyDat class |
