...
```csharp
public class BoxObstacle : pObstacle
```
...
```csharp
public ref class BoxObstacle : public pObstacle
```
...
The BoxObstacle type exposes the following members.


| Name | Description |
| --- | --- |
| BoxObstacle | Initializes a new instance of the BoxObstacle class |
