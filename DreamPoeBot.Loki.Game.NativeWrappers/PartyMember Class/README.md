...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.NativeWrappers.PartyMember"]
...
```csharp
public ref class PartyMember : public RemoteMemoryObject
```
...
## Дочерние разделы
- [**PartyMember Properties**](./PartyMember Properties/README.md)
- [**PartyMember Methods**](./PartyMember Methods/README.md)
- [**PartyMember Fields**](./PartyMember Fields/README.md)
