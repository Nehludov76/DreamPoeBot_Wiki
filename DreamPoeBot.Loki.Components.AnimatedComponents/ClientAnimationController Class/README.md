# ClientAnimationController Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Components.AnimatedComponents.ClientAnimationController"]
...
```csharp
public ref class ClientAnimationController : public Component
```
...
|  | Name | Description |
| --- | --- | --- |
|  | ClientAnimationController | Initializes a new instance of the ClientAnimationController class |
...
## Дочерние разделы
- [**ClientAnimationController Constructor **](./ClientAnimationController Constructor/README.md)
- [**ClientAnimationController Properties**](./ClientAnimationController Properties/README.md)
- [**ClientAnimationController Methods**](./ClientAnimationController Methods/README.md)
- [**ClientAnimationController Fields**](./ClientAnimationController Fields/README.md)
