...
```csharp
public ref class LabyrinthData : public RemoteMemoryObject
```
...
| Name | Description |
| --- | --- |
| LabyrinthData | Initializes a new instance of the LabyrinthData class |
| LabyrinthData(Int64) | Initializes a new instance of the LabyrinthData class |
