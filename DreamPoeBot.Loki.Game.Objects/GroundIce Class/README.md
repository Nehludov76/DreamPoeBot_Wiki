...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundIce"]
...
```csharp
public ref class GroundIce : public NetworkObject
```
...
The GroundIce type exposes the following members.
...
## Дочерние разделы
- [**GroundIce Properties**](./GroundIce Properties/README.md)
- [**GroundIce Methods**](./GroundIce Methods/README.md)
