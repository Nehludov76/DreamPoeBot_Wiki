...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.BeyondPortal"]
...
```csharp
public ref class BeyondPortal : public NetworkObject
```
...
The BeyondPortal type exposes the following members.
...
## Дочерние разделы
- [**BeyondPortal Properties**](./BeyondPortal Properties/README.md)
- [**BeyondPortal Methods**](./BeyondPortal Methods/README.md)
