...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.NecropolisCorpse"]


```csharp
public class NecropolisCorpse : NetworkObject
```
...
```csharp
public ref class NecropolisCorpse : public NetworkObject
```
...
## Дочерние разделы
- [**NecropolisCorpse Properties**](./NecropolisCorpse Properties/README.md)
- [**NecropolisCorpse Methods**](./NecropolisCorpse Methods/README.md)
