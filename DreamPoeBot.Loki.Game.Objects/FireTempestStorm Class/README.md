...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.FireTempestStorm"]
...
```csharp
public ref class FireTempestStorm : public NetworkObject
```
...
The FireTempestStorm type exposes the following members.
...
## Дочерние разделы
- [**FireTempestStorm Properties**](./FireTempestStorm Properties/README.md)
- [**FireTempestStorm Methods**](./FireTempestStorm Methods/README.md)
- [**FireTempestStorm Fields**](./FireTempestStorm Fields/README.md)
