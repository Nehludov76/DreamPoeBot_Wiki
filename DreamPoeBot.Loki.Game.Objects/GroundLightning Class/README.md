...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundLightning"]
...
```csharp
public ref class GroundLightning : public NetworkObject
```
...
The GroundLightning type exposes the following members.
...
## Дочерние разделы
- [**GroundLightning Properties**](./GroundLightning Properties/README.md)
- [**GroundLightning Methods**](./GroundLightning Methods/README.md)
