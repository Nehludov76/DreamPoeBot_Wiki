...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.StoneAltar"]
...
```csharp
public ref class StoneAltar : public NetworkObject
```
...
## Дочерние разделы
- [**StoneAltar Properties**](./StoneAltar Properties/README.md)
- [**StoneAltar Methods**](./StoneAltar Methods/README.md)
- [**StoneAltar Fields**](./StoneAltar Fields/README.md)
