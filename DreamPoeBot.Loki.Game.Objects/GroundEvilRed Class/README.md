...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundEvilRed"]
...
```csharp
public ref class GroundEvilRed : public NetworkObject
```
...
The GroundEvilRed type exposes the following members.
...
## Дочерние разделы
- [**GroundEvilRed Properties**](./GroundEvilRed Properties/README.md)
- [**GroundEvilRed Methods**](./GroundEvilRed Methods/README.md)
