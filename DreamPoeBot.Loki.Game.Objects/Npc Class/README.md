...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Npc"]
...
```csharp
public ref class Npc : public NetworkObject
```
...
## Дочерние разделы
- [**Npc Properties**](./Npc Properties/README.md)
- [**Npc Methods**](./Npc Methods/README.md)
