...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundSpike"]
...
```csharp
public ref class GroundSpike : public NetworkObject
```
...
The GroundSpike type exposes the following members.
...
## Дочерние разделы
- [**GroundSpike Properties**](./GroundSpike Properties/README.md)
- [**GroundSpike Methods**](./GroundSpike Methods/README.md)
