...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundEvil"]
...
```csharp
public ref class GroundEvil : public NetworkObject
```
...
The GroundEvil type exposes the following members.
...
## Дочерние разделы
- [**GroundEvil Properties**](./GroundEvil Properties/README.md)
- [**GroundEvil Methods**](./GroundEvil Methods/README.md)
