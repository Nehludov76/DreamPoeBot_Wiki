...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.CraftingRecipe"]
...
```csharp
public ref class CraftingRecipe : public NetworkObject
```
...
The CraftingRecipe type exposes the following members.
...
## Дочерние разделы
- [**CraftingRecipe Properties**](./CraftingRecipe Properties/README.md)
- [**CraftingRecipe Methods**](./CraftingRecipe Methods/README.md)
