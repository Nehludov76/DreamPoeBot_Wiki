...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.DarkShrine"]
...
```csharp
public ref class DarkShrine : public NetworkObject
```
...
## Дочерние разделы
- [**DarkShrine Properties**](./DarkShrine Properties/README.md)
- [**DarkShrine Methods**](./DarkShrine Methods/README.md)
- [**DarkShrine Fields**](./DarkShrine Fields/README.md)
