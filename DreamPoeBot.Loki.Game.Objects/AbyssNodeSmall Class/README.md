...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssNodeSmall"]
...
```csharp
public ref class AbyssNodeSmall : public TriggerableBlockage
```
...
The AbyssNodeSmall type exposes the following members.
...
## Дочерние разделы
- [**AbyssNodeSmall Properties**](./AbyssNodeSmall Properties/README.md)
- [**AbyssNodeSmall Methods**](./AbyssNodeSmall Methods/README.md)
