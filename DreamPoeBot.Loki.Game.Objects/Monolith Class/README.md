...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Monolith"]
...
```csharp
public ref class Monolith : public NetworkObject
```
...
|  | Upgrade | Click a specific upgrade option to upgrade the monolith. |
...
## Дочерние разделы
- [**Monolith Properties**](./Monolith Properties/README.md)
- [**Monolith Methods**](./Monolith Methods/README.md)
- [**Monolith Fields**](./Monolith Fields/README.md)
