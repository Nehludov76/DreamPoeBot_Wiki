...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GuildStash"]
...
```csharp
public ref class GuildStash : public NetworkObject
```
...
## Дочерние разделы
- [**GuildStash Properties**](./GuildStash Properties/README.md)
- [**GuildStash Methods**](./GuildStash Methods/README.md)
- [**GuildStash Fields**](./GuildStash Fields/README.md)
