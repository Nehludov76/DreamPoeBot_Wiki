...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.BreachSkillObject"]


```csharp
public class BreachSkillObject : NetworkObject
```
...
```csharp
public ref class BreachSkillObject : public NetworkObject
```
...
The BreachSkillObject type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | _entity | (Inherited from NetworkObject .) |
|  | ActionTitle | Return the Title of the action for the breach skill button. |
...
|  | Name | Description |
| --- | --- | --- |
|  | Activate | Click to activate the Breach skill -. |
|  | Dump |  |
...
## Дочерние разделы
- [**BreachSkillObject Properties**](./BreachSkillObject Properties/README.md)
- [**BreachSkillObject Methods**](./BreachSkillObject Methods/README.md)
