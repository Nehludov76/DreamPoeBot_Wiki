...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssFinalNodeChest"]
...
```csharp
public ref class AbyssFinalNodeChest : public TriggerableBlockage
```
...
The AbyssFinalNodeChest type exposes the following members.
...
## Дочерние разделы
- [**AbyssFinalNodeChest Properties**](./AbyssFinalNodeChest Properties/README.md)
- [**AbyssFinalNodeChest Methods**](./AbyssFinalNodeChest Methods/README.md)
