...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.BloodPool"]
...
```csharp
public ref class BloodPool : public NetworkObject
```
...
## Дочерние разделы
- [**BloodPool Properties**](./BloodPool Properties/README.md)
- [**BloodPool Methods**](./BloodPool Methods/README.md)
- [**BloodPool Fields**](./BloodPool Fields/README.md)
