...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Stash"]
...
```csharp
public ref class Stash : public NetworkObject
```
...
## Дочерние разделы
- [**Stash Properties**](./Stash Properties/README.md)
- [**Stash Methods**](./Stash Methods/README.md)
- [**Stash Fields**](./Stash Fields/README.md)
