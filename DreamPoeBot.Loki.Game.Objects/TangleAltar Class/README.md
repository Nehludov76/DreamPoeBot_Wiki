...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.TangleAltar"]
...
```csharp
public ref class TangleAltar : public NetworkObject
```
...
The TangleAltar type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | TangleAltar | Initializes a new instance of the TangleAltar class |
...
|  | Options | Return the 2 available options for the Tangle Altar menu |
...
## Дочерние разделы
- [**TangleAltar Constructor **](./TangleAltar Constructor/README.md)
- [**TangleAltar Properties**](./TangleAltar Properties/README.md)
- [**TangleAltar Methods**](./TangleAltar Methods/README.md)
