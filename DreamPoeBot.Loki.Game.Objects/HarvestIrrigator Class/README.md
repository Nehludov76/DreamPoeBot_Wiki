...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.HarvestIrrigator"]
...
```csharp
public ref class HarvestIrrigator : public NetworkObject
```
...
The HarvestIrrigator type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | HarvestIrrigator | Initializes a new instance of the HarvestIrrigator class |
...
|  | CraftingOutCome | Obsolete. |
|  | Description | If the User interface is visible, it return the functionality of this button as show in the Tooltip, Ex. Craft. |
...
|  | IsUiVisible | Return true if the User interface for this Object is visible |
|  | IsUltimatumChallengeInteractable | (Inherited from NetworkObject .) |
|  | IsValid | (Inherited from NetworkObject .) |
|  | MagicProperties | Obsolete. Return a List of string rapresenting the Magic properties of this button as show in the upper user interface. |
|  | Menu |  |
...
## Дочерние разделы
- [**HarvestIrrigator Constructor **](./HarvestIrrigator Constructor/README.md)
- [**HarvestIrrigator Properties**](./HarvestIrrigator Properties/README.md)
- [**HarvestIrrigator Methods**](./HarvestIrrigator Methods/README.md)
