...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AflictionInitiator"]
...
```csharp
public ref class AflictionInitiator : public NetworkObject
```
...
The AflictionInitiator type exposes the following members.
...
## Дочерние разделы
- [**AflictionInitiator Properties**](./AflictionInitiator Properties/README.md)
- [**AflictionInitiator Methods**](./AflictionInitiator Methods/README.md)
