...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.HeistInteractableDoor"]


```csharp
public class HeistInteractableDoor : TriggerableBlockage
```
...
```csharp
public ref class HeistInteractableDoor : public TriggerableBlockage
```
...
The HeistInteractableDoor type exposes the following members.


| Name | Description |
| --- | --- |
| HeistInteractableDoor | Initializes a new instance of the HeistInteractableDoor class |
