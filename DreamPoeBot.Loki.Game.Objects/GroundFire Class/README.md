...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundFire"]
...
```csharp
public ref class GroundFire : public NetworkObject
```
...
The GroundFire type exposes the following members.
...
## Дочерние разделы
- [**GroundFire Properties**](./GroundFire Properties/README.md)
- [**GroundFire Methods**](./GroundFire Methods/README.md)
