...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.WorldItem"]
...
```csharp
public ref class WorldItem : public NetworkObject
```
...
|  | Name | Description |
| --- | --- | --- |
|  | WorldItem | Initializes a new instance of the WorldItem class |


|  | Name | Description |
| --- | --- | --- |
|  | _entity | (Inherited from NetworkObject .) |
|  | AllocatedToOtherTime |  |
|  | AllocatedToPlayer |  |
...
|  | GetClickableHighlightLabelDimensions |  |
...
## Дочерние разделы
- [**WorldItem Constructor **](./WorldItem Constructor/README.md)
- [**WorldItem Properties**](./WorldItem Properties/README.md)
- [**WorldItem Methods**](./WorldItem Methods/README.md)
