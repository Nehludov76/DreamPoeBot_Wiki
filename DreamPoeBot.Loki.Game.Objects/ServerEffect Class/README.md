...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.ServerEffect"]
...
```csharp
public ref class ServerEffect : public NetworkObject
```
...
## Дочерние разделы
- [**ServerEffect Properties**](./ServerEffect Properties/README.md)
- [**ServerEffect Methods**](./ServerEffect Methods/README.md)
- [**ServerEffect Fields**](./ServerEffect Fields/README.md)
