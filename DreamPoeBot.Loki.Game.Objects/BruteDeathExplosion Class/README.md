...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.BruteDeathExplosion"]
...
```csharp
public ref class BruteDeathExplosion : public NetworkObject
```
...
## Дочерние разделы
- [**BruteDeathExplosion Properties**](./BruteDeathExplosion Properties/README.md)
- [**BruteDeathExplosion Methods**](./BruteDeathExplosion Methods/README.md)
- [**BruteDeathExplosion Fields**](./BruteDeathExplosion Fields/README.md)
