...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundPoison"]
...
```csharp
public ref class GroundPoison : public NetworkObject
```
...
The GroundPoison type exposes the following members.
...
## Дочерние разделы
- [**GroundPoison Properties**](./GroundPoison Properties/README.md)
- [**GroundPoison Methods**](./GroundPoison Methods/README.md)
