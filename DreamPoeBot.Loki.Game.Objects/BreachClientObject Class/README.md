...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.BreachClientObject"]
...
```csharp
public ref class BreachClientObject : public NetworkObject
```
...
## Дочерние разделы
- [**BreachClientObject Properties**](./BreachClientObject Properties/README.md)
- [**BreachClientObject Methods**](./BreachClientObject Methods/README.md)
- [**BreachClientObject Fields**](./BreachClientObject Fields/README.md)
