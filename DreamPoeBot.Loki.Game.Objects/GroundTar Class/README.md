...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundTar"]
...
```csharp
public ref class GroundTar : public NetworkObject
```
...
The GroundTar type exposes the following members.
...
## Дочерние разделы
- [**GroundTar Properties**](./GroundTar Properties/README.md)
- [**GroundTar Methods**](./GroundTar Methods/README.md)
