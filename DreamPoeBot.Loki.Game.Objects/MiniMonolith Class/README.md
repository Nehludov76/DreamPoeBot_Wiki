...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.MiniMonolith"]
...
```csharp
public ref class MiniMonolith : public Monolith
```
...
The MiniMonolith type exposes the following members.
...
|  | ChildNetworkObject | (Inherited from Monolith .) |
|  | ChildNetworkObjectId | (Inherited from Monolith .) |
...
|  | EssenceBaseItemTypes | (Inherited from Monolith .) |
...
|  | IsCorrupted | (Inherited from Monolith .) |
...
|  | IsMini | (Overrides Monolith IsMini .) |
...
|  | MonsterTypeId | (Inherited from Monolith .) |
|  | MonsterTypeMetadata | (Inherited from Monolith .) |
|  | Name | (Inherited from Monolith .) |
|  | OpenPhase | (Inherited from Monolith .) |
|  | Position | (Inherited from NetworkObject .) |
|  | Reaction | (Inherited from NetworkObject .) |
|  | Type | (Inherited from NetworkObject .) |
|  | UpgradeOptions | Return a list the Items that can be used to upgrade the chest (Inherited from Monolith .) |
...
|  | ToString | (Inherited from Monolith .) |
|  | Upgrade | Click a specific upgrade option to upgrade the monolith. (Inherited from Monolith .) |
...
## Дочерние разделы
- [**MiniMonolith Properties**](./MiniMonolith Properties/README.md)
- [**MiniMonolith Methods**](./MiniMonolith Methods/README.md)
- [**MiniMonolith Fields**](./MiniMonolith Fields/README.md)
