...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.LegionInitiator"]
...
```csharp
public ref class LegionInitiator : public NetworkObject
```
...
The LegionInitiator type exposes the following members.
...
## Дочерние разделы
- [**LegionInitiator Properties**](./LegionInitiator Properties/README.md)
- [**LegionInitiator Methods**](./LegionInitiator Methods/README.md)
