...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.IceTempestStorm"]
...
```csharp
public ref class IceTempestStorm : public NetworkObject
```
...
The IceTempestStorm type exposes the following members.
...
## Дочерние разделы
- [**IceTempestStorm Properties**](./IceTempestStorm Properties/README.md)
- [**IceTempestStorm Methods**](./IceTempestStorm Methods/README.md)
- [**IceTempestStorm Fields**](./IceTempestStorm Fields/README.md)
