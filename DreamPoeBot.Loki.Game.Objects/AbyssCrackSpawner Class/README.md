...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssCrackSpawner"]
...
```csharp
public ref class AbyssCrackSpawner : public NetworkObject
```
...
The AbyssCrackSpawner type exposes the following members.
...
## Дочерние разделы
- [**AbyssCrackSpawner Properties**](./AbyssCrackSpawner Properties/README.md)
- [**AbyssCrackSpawner Methods**](./AbyssCrackSpawner Methods/README.md)
