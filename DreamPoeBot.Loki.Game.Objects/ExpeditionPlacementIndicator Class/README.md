# ExpeditionPlacementIndicator Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.ExpeditionPlacementIndicator"]
...
```csharp
public ref class ExpeditionPlacementIndicator : public NetworkObject
```
...
The ExpeditionPlacementIndicator type exposes the following members.
...
## Дочерние разделы
- [**ExpeditionPlacementIndicator Properties**](./ExpeditionPlacementIndicator Properties/README.md)
- [**ExpeditionPlacementIndicator Methods**](./ExpeditionPlacementIndicator Methods/README.md)
