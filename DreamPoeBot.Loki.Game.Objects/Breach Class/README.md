...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Breach"]
...
```csharp
public ref class Breach : public NetworkObject
```
...
The Breach type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | _entity | (Inherited from NetworkObject .) |
|  | ActionTitle | Return the Title of the action for the breach button. |
...
|  | Name | Description |
| --- | --- | --- |
|  | Activate | Click to activate the Breach event. |
...
- [**Breach Methods**](./Breach Methods/README.md)
