...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.HarvestExtraxtor"]
...
```csharp
public ref class HarvestExtraxtor : public NetworkObject
```
...
The HarvestExtraxtor type exposes the following members.


| Name | Description |
| --- | --- |
| HarvestExtraxtor | Initializes a new instance of the HarvestExtraxtor class |
