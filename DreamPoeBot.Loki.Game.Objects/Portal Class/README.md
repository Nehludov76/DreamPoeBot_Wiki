...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Portal"]
...
```csharp
public ref class Portal : public NetworkObject
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Portal | Initializes a new instance of the Portal class |
...
## Дочерние разделы
- [**Portal Constructor **](./Portal Constructor/README.md)
- [**Portal Properties**](./Portal Properties/README.md)
- [**Portal Methods**](./Portal Methods/README.md)
