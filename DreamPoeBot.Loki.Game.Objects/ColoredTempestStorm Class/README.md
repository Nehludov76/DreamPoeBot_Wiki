...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.ColoredTempestStorm"]
...
```csharp
public ref class ColoredTempestStorm : public NetworkObject
```
...
The ColoredTempestStorm type exposes the following members.
...
## Дочерние разделы
- [**ColoredTempestStorm Properties**](./ColoredTempestStorm Properties/README.md)
- [**ColoredTempestStorm Methods**](./ColoredTempestStorm Methods/README.md)
