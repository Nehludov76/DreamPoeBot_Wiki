...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Shrine"]
...
```csharp
public ref class Shrine : public NetworkObject
```
...
The Shrine type exposes the following members.
...
## Дочерние разделы
- [**Shrine Properties**](./Shrine Properties/README.md)
- [**Shrine Methods**](./Shrine Methods/README.md)
