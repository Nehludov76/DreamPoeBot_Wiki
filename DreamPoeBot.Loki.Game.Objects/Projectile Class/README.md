...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Projectile"]
...
```csharp
public ref class Projectile : public NetworkObject
```
...
## Дочерние разделы
- [**Projectile Properties**](./Projectile Properties/README.md)
- [**Projectile Methods**](./Projectile Methods/README.md)
