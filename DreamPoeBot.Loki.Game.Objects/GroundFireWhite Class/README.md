...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundFireWhite"]
...
```csharp
public ref class GroundFireWhite : public NetworkObject
```
...
The GroundFireWhite type exposes the following members.
...
## Дочерние разделы
- [**GroundFireWhite Properties**](./GroundFireWhite Properties/README.md)
- [**GroundFireWhite Methods**](./GroundFireWhite Methods/README.md)
