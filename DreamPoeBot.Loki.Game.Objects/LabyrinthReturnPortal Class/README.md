...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.LabyrinthReturnPortal"]
...
```csharp
public ref class LabyrinthReturnPortal : public Portal
```
...
The LabyrinthReturnPortal type exposes the following members.
...
## Дочерние разделы
- [**LabyrinthReturnPortal Properties**](./LabyrinthReturnPortal Properties/README.md)
- [**LabyrinthReturnPortal Methods**](./LabyrinthReturnPortal Methods/README.md)
