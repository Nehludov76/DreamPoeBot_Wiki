...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssFinalNodeSubArea"]
...
```csharp
public ref class AbyssFinalNodeSubArea : public TriggerableBlockage
```
...
The AbyssFinalNodeSubArea type exposes the following members.
...
|  | BoundsMax | (Inherited from TriggerableBlockage .) |
|  | BoundsMin | (Inherited from TriggerableBlockage .) |
...
|  | IsOpened | (Inherited from TriggerableBlockage .) |
...
|  | Name | (Overrides NetworkObject Name .) |
|  | OpenedOverlayNavData | (Inherited from TriggerableBlockage .) |
|  | Position | (Inherited from NetworkObject .) |
|  | Reaction | (Inherited from NetworkObject .) |
|  | Size | (Inherited from TriggerableBlockage .) |
...
## Дочерние разделы
- [**AbyssFinalNodeSubArea Properties**](./AbyssFinalNodeSubArea Properties/README.md)
- [**AbyssFinalNodeSubArea Methods**](./AbyssFinalNodeSubArea Methods/README.md)
