...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Effect"]
...
```csharp
public ref class Effect : public NetworkObject
```
...
## Дочерние разделы
- [**Effect Properties**](./Effect Properties/README.md)
- [**Effect Methods**](./Effect Methods/README.md)
- [**Effect Fields**](./Effect Fields/README.md)
