...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.Waypoint"]
...
```csharp
public ref class Waypoint : public NetworkObject
```
...
## Дочерние разделы
- [**Waypoint Properties**](./Waypoint Properties/README.md)
- [**Waypoint Methods**](./Waypoint Methods/README.md)
- [**Waypoint Fields**](./Waypoint Fields/README.md)
