...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssStartNode"]
...
```csharp
public ref class AbyssStartNode : public NetworkObject
```
...
The AbyssStartNode type exposes the following members.
...
## Дочерние разделы
- [**AbyssStartNode Properties**](./AbyssStartNode Properties/README.md)
- [**AbyssStartNode Methods**](./AbyssStartNode Methods/README.md)
