...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssNodeMini"]
...
```csharp
public ref class AbyssNodeMini : public NetworkObject
```
...
The AbyssNodeMini type exposes the following members.
...
## Дочерние разделы
- [**AbyssNodeMini Properties**](./AbyssNodeMini Properties/README.md)
- [**AbyssNodeMini Methods**](./AbyssNodeMini Methods/README.md)
