...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.TriggerableBlockage"]
...
```csharp
public ref class TriggerableBlockage : public NetworkObject
```
