...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.GroundHoly"]
...
```csharp
public ref class GroundHoly : public NetworkObject
```
...
The GroundHoly type exposes the following members.
...
## Дочерние разделы
- [**GroundHoly Properties**](./GroundHoly Properties/README.md)
- [**GroundHoly Methods**](./GroundHoly Methods/README.md)
