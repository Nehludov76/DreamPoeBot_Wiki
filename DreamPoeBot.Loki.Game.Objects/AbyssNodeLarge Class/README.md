...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.Objects.AbyssNodeLarge"]
...
```csharp
public ref class AbyssNodeLarge : public TriggerableBlockage
```
...
The AbyssNodeLarge type exposes the following members.
...
## Дочерние разделы
- [**AbyssNodeLarge Properties**](./AbyssNodeLarge Properties/README.md)
- [**AbyssNodeLarge Methods**](./AbyssNodeLarge Methods/README.md)
