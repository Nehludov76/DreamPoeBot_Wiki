...
```csharp
public class CurrentConfigurationGui : UserControl , IComponentConnector
```
...
```csharp
public ref class CurrentConfigurationGui : public UserControl , IComponentConnector
```
...
The CurrentConfigurationGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | CurrentConfigurationGui | Initializes a new instance of the CurrentConfigurationGui class |
...
## Дочерние разделы
- [**CurrentConfigurationGui Constructor **](./CurrentConfigurationGui Constructor/README.md)
- [**CurrentConfigurationGui Properties**](./CurrentConfigurationGui Properties/README.md)
- [**CurrentConfigurationGui Methods**](./CurrentConfigurationGui Methods/README.md)
- [**CurrentConfigurationGui Events**](./CurrentConfigurationGui Events/README.md)
