...
```csharp
public class MoverTemplateGui : UserControl , IComponentConnector
```
...
```csharp
public ref class MoverTemplateGui : public UserControl , IComponentConnector
```
...
The MoverTemplateGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MoverTemplateGui | Initializes a new instance of the MoverTemplateGui class |
...
## Дочерние разделы
- [**MoverTemplateGui Constructor **](./MoverTemplateGui Constructor/README.md)
- [**MoverTemplateGui Properties**](./MoverTemplateGui Properties/README.md)
- [**MoverTemplateGui Methods**](./MoverTemplateGui Methods/README.md)
- [**MoverTemplateGui Events**](./MoverTemplateGui Events/README.md)
