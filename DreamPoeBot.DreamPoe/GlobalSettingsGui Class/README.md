...
```csharp
public class GlobalSettingsGui : UserControl , IComponentConnector
```
...
```csharp
public ref class GlobalSettingsGui : public UserControl , IComponentConnector
```
...
The GlobalSettingsGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | GlobalSettingsGui | Initializes a new instance of the GlobalSettingsGui class |
...
## Дочерние разделы
- [**GlobalSettingsGui Constructor **](./GlobalSettingsGui Constructor/README.md)
- [**GlobalSettingsGui Properties**](./GlobalSettingsGui Properties/README.md)
- [**GlobalSettingsGui Methods**](./GlobalSettingsGui Methods/README.md)
- [**GlobalSettingsGui Events**](./GlobalSettingsGui Events/README.md)
