...
[Missing <summary> documentation for "T:DreamPoeBot.DreamPoe.TimePicker"]
...
```csharp
public ref class TimePicker : public Control
```
...
|  | OnCreateAutomationPeer | Returns class-specific AutomationPeer implementations for the Windows Presentation Foundation (WPF) infrastructure. (Inherited from UIElement .) |
...
|  | SelectedSecondProperty |  |
|  | SelectedTimeChangedEvent |  |
|  | SelectedTimeProperty |  |

## Дочерние разделы
- [**TimePicker Constructor **](./TimePicker Constructor/README.md)
- [**TimePicker Properties**](./TimePicker Properties/README.md)
- [**TimePicker Methods**](./TimePicker Methods/README.md)
- [**TimePicker Events**](./TimePicker Events/README.md)
- [**TimePicker Fields**](./TimePicker Fields/README.md)
