...
```csharp
public class RoutineManagerGui : UserControl , IComponentConnector
```
...
```csharp
public ref class RoutineManagerGui : public UserControl , IComponentConnector
```
...
The RoutineManagerGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | RoutineManagerGui | Initializes a new instance of the RoutineManagerGui class |
...
## Дочерние разделы
- [**RoutineManagerGui Constructor **](./RoutineManagerGui Constructor/README.md)
- [**RoutineManagerGui Properties**](./RoutineManagerGui Properties/README.md)
- [**RoutineManagerGui Methods**](./RoutineManagerGui Methods/README.md)
- [**RoutineManagerGui Events**](./RoutineManagerGui Events/README.md)
