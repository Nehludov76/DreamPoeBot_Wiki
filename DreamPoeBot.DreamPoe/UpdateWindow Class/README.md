...
```csharp
public class UpdateWindow : UserControl , IComponentConnector
```
...
```csharp
public ref class UpdateWindow : public UserControl , IComponentConnector
```
...
|  | Name | Description |
| --- | --- | --- |
|  | UpdateWindow | Initializes a new instance of the UpdateWindow class |
...
## Дочерние разделы
- [**UpdateWindow Constructor **](./UpdateWindow Constructor/README.md)
- [**UpdateWindow Properties**](./UpdateWindow Properties/README.md)
- [**UpdateWindow Methods**](./UpdateWindow Methods/README.md)
- [**UpdateWindow Events**](./UpdateWindow Events/README.md)
