...
```csharp
public class ThirdPartySettingsGui : UserControl , IComponentConnector
```
...
```csharp
public ref class ThirdPartySettingsGui : public UserControl , IComponentConnector
```
...
The ThirdPartySettingsGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ThirdPartySettingsGui | Initializes a new instance of the ThirdPartySettingsGui class |
...
## Дочерние разделы
- [**ThirdPartySettingsGui Constructor **](./ThirdPartySettingsGui Constructor/README.md)
- [**ThirdPartySettingsGui Properties**](./ThirdPartySettingsGui Properties/README.md)
- [**ThirdPartySettingsGui Methods**](./ThirdPartySettingsGui Methods/README.md)
- [**ThirdPartySettingsGui Events**](./ThirdPartySettingsGui Events/README.md)
