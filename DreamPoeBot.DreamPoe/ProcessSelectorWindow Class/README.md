...
```csharp
public class ProcessSelectorWindow : UserControl , IComponentConnector
```
...
```csharp
public ref class ProcessSelectorWindow : public UserControl , IComponentConnector
```
...
The ProcessSelectorWindow type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ProcessSelectorWindow | Initializes a new instance of the ProcessSelectorWindow class |
...
## Дочерние разделы
- [**ProcessSelectorWindow Constructor **](./ProcessSelectorWindow Constructor/README.md)
- [**ProcessSelectorWindow Properties**](./ProcessSelectorWindow Properties/README.md)
- [**ProcessSelectorWindow Methods**](./ProcessSelectorWindow Methods/README.md)
- [**ProcessSelectorWindow Events**](./ProcessSelectorWindow Events/README.md)
