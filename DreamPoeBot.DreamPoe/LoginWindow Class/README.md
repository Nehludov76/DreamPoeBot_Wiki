...
```csharp
public class LoginWindow : UserControl , IComponentConnector
```
...
```csharp
public ref class LoginWindow : public UserControl , IComponentConnector
```
...
The LoginWindow type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | LoginWindow | Initializes a new instance of the LoginWindow class |
...
## Дочерние разделы
- [**LoginWindow Constructor **](./LoginWindow Constructor/README.md)
- [**LoginWindow Properties**](./LoginWindow Properties/README.md)
- [**LoginWindow Methods**](./LoginWindow Methods/README.md)
- [**LoginWindow Events**](./LoginWindow Events/README.md)
