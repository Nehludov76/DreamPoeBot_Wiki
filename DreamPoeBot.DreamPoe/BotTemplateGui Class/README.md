...
```csharp
public class BotTemplateGui : UserControl , IComponentConnector
```
...
```csharp
public ref class BotTemplateGui : public UserControl , IComponentConnector
```
...
|  | Name | Description |
| --- | --- | --- |
|  | BotTemplateGui | Initializes a new instance of the BotTemplateGui class |
...
## Дочерние разделы
- [**BotTemplateGui Constructor **](./BotTemplateGui Constructor/README.md)
- [**BotTemplateGui Properties**](./BotTemplateGui Properties/README.md)
- [**BotTemplateGui Methods**](./BotTemplateGui Methods/README.md)
- [**BotTemplateGui Events**](./BotTemplateGui Events/README.md)
