...
```csharp
public class PluginTemplateGui : UserControl , IComponentConnector
```
...
```csharp
public ref class PluginTemplateGui : public UserControl , IComponentConnector
```
...
The PluginTemplateGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PluginTemplateGui | Initializes a new instance of the PluginTemplateGui class |
...
## Дочерние разделы
- [**PluginTemplateGui Constructor **](./PluginTemplateGui Constructor/README.md)
- [**PluginTemplateGui Properties**](./PluginTemplateGui Properties/README.md)
- [**PluginTemplateGui Methods**](./PluginTemplateGui Methods/README.md)
- [**PluginTemplateGui Events**](./PluginTemplateGui Events/README.md)
