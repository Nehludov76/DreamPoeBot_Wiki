...
```csharp
public class MoverManagerGui : UserControl , IComponentConnector
```
...
```csharp
public ref class MoverManagerGui : public UserControl , IComponentConnector
```
...
The MoverManagerGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | MoverManagerGui | Initializes a new instance of the MoverManagerGui class |
...
## Дочерние разделы
- [**MoverManagerGui Constructor **](./MoverManagerGui Constructor/README.md)
- [**MoverManagerGui Properties**](./MoverManagerGui Properties/README.md)
- [**MoverManagerGui Methods**](./MoverManagerGui Methods/README.md)
- [**MoverManagerGui Events**](./MoverManagerGui Events/README.md)
