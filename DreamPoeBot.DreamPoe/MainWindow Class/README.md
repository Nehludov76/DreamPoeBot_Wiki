...
```csharp
public ref class MainWindow : public MetroWindow , IComponentConnector
```
...
|  | IsAdministrator | Boolean method that verifies if the current user has administrator rights. |
...
|  | OnSourceInitialized | (Overrides Window OnSourceInitialized(EventArgs) .) |
|  | OnStateChanged | (Overrides Window OnStateChanged(EventArgs) .) |
...
|  | ChangeLanguageToEs |  |
|  | ChangeLanguageToFr |  |
|  | ChangeLanguageToInvariant |  |
|  | ChangeLanguageToRu |  |
|  | ChangeLanguageToZhCn |  |
|  | OpenSettingsWindow |  |

## Дочерние разделы
- [**MainWindow Constructor **](./MainWindow Constructor/README.md)
- [**MainWindow Properties**](./MainWindow Properties/README.md)
- [**MainWindow Methods**](./MainWindow Methods/README.md)
- [**MainWindow Events**](./MainWindow Events/README.md)
- [**MainWindow Fields**](./MainWindow Fields/README.md)
