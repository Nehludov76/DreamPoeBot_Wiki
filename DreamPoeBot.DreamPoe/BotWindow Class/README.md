...
```csharp
public class BotWindow : UserControl , IComponentConnector
```
...
```csharp
public ref class BotWindow : public UserControl , IComponentConnector
```
...
The BotWindow type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BotWindow | Initializes a new instance of the BotWindow class |
...
## Дочерние разделы
- [**BotWindow Constructor **](./BotWindow Constructor/README.md)
- [**BotWindow Properties**](./BotWindow Properties/README.md)
- [**BotWindow Methods**](./BotWindow Methods/README.md)
- [**BotWindow Events**](./BotWindow Events/README.md)
