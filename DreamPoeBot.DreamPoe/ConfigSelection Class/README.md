...
```csharp
public class ConfigSelection : UserControl , IComponentConnector
```
...
```csharp
public ref class ConfigSelection : public UserControl , IComponentConnector
```
...
The ConfigSelection type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ConfigSelection | Initializes a new instance of the ConfigSelection class |
...
## Дочерние разделы
- [**ConfigSelection Constructor **](./ConfigSelection Constructor/README.md)
- [**ConfigSelection Properties**](./ConfigSelection Properties/README.md)
- [**ConfigSelection Methods**](./ConfigSelection Methods/README.md)
- [**ConfigSelection Events**](./ConfigSelection Events/README.md)
