...
```csharp
public class LanguageSelection : UserControl , IComponentConnector
```
...
```csharp
public ref class LanguageSelection : public UserControl , IComponentConnector
```
...
The LanguageSelection type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | LanguageSelection | Initializes a new instance of the LanguageSelection class |
...
## Дочерние разделы
- [**LanguageSelection Constructor **](./LanguageSelection Constructor/README.md)
- [**LanguageSelection Properties**](./LanguageSelection Properties/README.md)
- [**LanguageSelection Methods**](./LanguageSelection Methods/README.md)
- [**LanguageSelection Events**](./LanguageSelection Events/README.md)
