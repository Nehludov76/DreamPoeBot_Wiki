...
```csharp
public class BotManagerGui : UserControl , IComponentConnector
```
...
```csharp
public ref class BotManagerGui : public UserControl , IComponentConnector
```
...
The BotManagerGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | BotManagerGui | Initializes a new instance of the BotManagerGui class |
...
## Дочерние разделы
- [**BotManagerGui Constructor **](./BotManagerGui Constructor/README.md)
- [**BotManagerGui Properties**](./BotManagerGui Properties/README.md)
- [**BotManagerGui Methods**](./BotManagerGui Methods/README.md)
- [**BotManagerGui Events**](./BotManagerGui Events/README.md)
