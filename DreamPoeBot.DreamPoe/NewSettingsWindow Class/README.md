...
```csharp
public ref class NewSettingsWindow : public MetroWindow , IComponentConnector
```
...
The NewSettingsWindow type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | NewSettingsWindow | Initializes a new instance of the NewSettingsWindow class |
...
|  | AllowsTransparency | Gets or sets a value that indicates whether a window's client area supports transparency. (Inherited from Window .) |
...
|  | CriticalHandle | (Inherited from MetroWindow .) |
...
|  | DialogResult | Gets or sets the dialog result value, which is the value that is returned from the ShowDialog method. (Inherited from Window .) |
...
|  | EnableDWMDropShadow | Obsolete. (Inherited from MetroWindow .) |
...
|  | Flyouts | (Inherited from MetroWindow .) |
...
|  | GlowBrush | (Inherited from MetroWindow .) |
...
|  | Icon | Gets or sets a window's icon. (Inherited from Window .) |
|  | IconBitmapScalingMode | (Inherited from MetroWindow .) |
|  | IconEdgeMode | (Inherited from MetroWindow .) |
|  | IconOverlayBehavior | (Inherited from MetroWindow .) |
|  | IconScalingMode | (Inherited from MetroWindow .) |
|  | IconTemplate | (Inherited from MetroWindow .) |
|  | IgnoreTaskbarOnMaximize | (Inherited from MetroWindow .) |
...
|  | IsActive | Gets a value that indicates whether the window is active. (Inherited from Window .) |
...
|  | IsCloseButtonEnabled | (Inherited from MetroWindow .) |
...
|  | IsMaxRestoreButtonEnabled | (Inherited from MetroWindow .) |
...
|  | IsMinButtonEnabled | (Inherited from MetroWindow .) |
...
|  | IsWindowDraggable | (Inherited from MetroWindow .) |
...
|  | Left | Gets or sets the position of the window's left edge, in relation to the desktop. (Inherited from Window .) |
|  | LeftWindowCommands | (Inherited from MetroWindow .) |
|  | LeftWindowCommandsOverlayBehavior | (Inherited from MetroWindow .) |
|  | LogicalChildren | (Inherited from MetroWindow .) |
...
|  | MetroDialogOptions | (Inherited from MetroWindow .) |
...
|  | NonActiveBorderBrush | (Inherited from MetroWindow .) |
|  | NonActiveGlowBrush | (Inherited from MetroWindow .) |
|  | NonActiveWindowTitleBrush | (Inherited from MetroWindow .) |
...
|  | OverlayBrush | (Inherited from MetroWindow .) |
|  | OverlayOpacity | (Inherited from MetroWindow .) |
|  | OverrideDefaultWindowCommandsBrush | (Inherited from MetroWindow .) |
...
|  | OwnedWindows | Gets a collection of windows for which this window is the owner. (Inherited from Window .) |
|  | Owner | Gets or sets the Window that owns this Window . (Inherited from Window .) |
...
|  | ResizeMode | Gets or sets the resize mode. (Inherited from Window .) |
|  | Resources | Gets or sets the locally-defined resource dictionary. (Inherited from FrameworkElement .) |
|  | RestoreBounds | Gets the size and location of a window before being either minimized or maximized. (Inherited from Window .) |
|  | RightWindowCommands | (Inherited from MetroWindow .) |
|  | RightWindowCommandsOverlayBehavior | (Inherited from MetroWindow .) |
|  | SaveWindowPosition | (Inherited from MetroWindow .) |
|  | ShowActivated | Gets or sets a value that indicates whether a window is activated when first shown. (Inherited from Window .) |
|  | ShowCloseButton | (Inherited from MetroWindow .) |
|  | ShowDialogsOverTitleBar | (Inherited from MetroWindow .) |
|  | ShowIconOnTitleBar | (Inherited from MetroWindow .) |
|  | ShowInTaskbar | Gets or sets a value that indicates whether the window has a task bar button. (Inherited from Window .) |
|  | ShowMaxRestoreButton | (Inherited from MetroWindow .) |
|  | ShowMinButton | (Inherited from MetroWindow .) |
|  | ShowSystemMenuOnRightClick | (Inherited from MetroWindow .) |
|  | ShowTitleBar | (Inherited from MetroWindow .) |
|  | SizeToContent | Gets or sets a value that indicates whether a window will automatically size itself to fit the size of its content. (Inherited from Window .) |
...
|  | TaskbarItemInfo | Gets or sets the Windows 7 taskbar thumbnail for the Window . (Inherited from Window .) |
...
|  | Title | Gets or sets a window's title. (Inherited from Window .) |
|  | TitleAlignment | (Inherited from MetroWindow .) |
|  | TitlebarHeight | (Inherited from MetroWindow .) |
|  | TitleCaps | Obsolete. (Inherited from MetroWindow .) |
|  | TitleCharacterCasing | (Inherited from MetroWindow .) |
|  | TitleForeground | (Inherited from MetroWindow .) |
|  | TitleTemplate | (Inherited from MetroWindow .) |
...
|  | Top | Gets or sets the position of the window's top edge, in relation to the desktop. (Inherited from Window .) |
|  | Topmost | Gets or sets a value that indicates whether a window appears in the topmost z-order. (Inherited from Window .) |
...
|  | UseNoneWindowStyle | (Inherited from MetroWindow .) |
...
|  | WindowButtonCommands | (Inherited from MetroWindow .) |
|  | WindowButtonCommandsOverlayBehavior | (Inherited from MetroWindow .) |
|  | WindowCloseButtonStyle | Obsolete. (Inherited from MetroWindow .) |
|  | WindowMaxButtonStyle | Obsolete. (Inherited from MetroWindow .) |
|  | WindowMinButtonStyle | Obsolete. (Inherited from MetroWindow .) |
|  | WindowPlacementSettings | (Inherited from MetroWindow .) |
|  | WindowStartupLocation | Gets or sets the position of the window when first shown. (Inherited from Window .) |
|  | WindowState | Gets or sets a value that indicates whether a window is restored, minimized, or maximized. (Inherited from Window .) |
|  | WindowStyle | Gets or sets a window's border style. (Inherited from Window .) |
|  | WindowTitle | Obsolete. (Inherited from MetroWindow .) |
|  | WindowTitleBrush | (Inherited from MetroWindow .) |
|  | WindowTransitionsEnabled | (Inherited from MetroWindow .) |


|  | Name | Description |
| --- | --- | --- |
|  | Activate | Attempts to bring the window to the foreground and activates it. (Inherited from Window .) |
...
|  | ArrangeOverride | Override this method to arrange and size a window and its child elements. (Inherited from Window .) |
...
|  | Close | Manually closes a Window . (Inherited from Window .) |
...
|  | DragMove | Allows a window to be dragged by a mouse with its left button down over an exposed area of the window's client area. (Inherited from Window .) |
...
|  | GetWindowPlacementSettings | (Inherited from MetroWindow .) |
|  | Hide | Makes a window invisible. (Inherited from Window .) |
|  | HideOverlay | (Inherited from MetroWindow .) |
|  | HideOverlayAsync | (Inherited from MetroWindow .) |
...
|  | IsOverlayVisible | (Inherited from MetroWindow .) |
...
|  | MeasureOverride | Override this method to measure the size of a window. (Inherited from Window .) |
...
|  | OnActivated | Raises the Activated event. (Inherited from Window .) |
|  | OnApplyTemplate | (Inherited from MetroWindow .) |
|  | OnChildDesiredSizeChanged | Supports layout behavior when a child element is resized. (Inherited from UIElement .) |
|  | OnClosed | Raises the Closed event. (Inherited from Window .) |
|  | OnClosing | (Inherited from MetroWindow .) |
|  | OnContentChanged | Called when the Content property changes. (Inherited from Window .) |
|  | OnContentRendered | Raises the ContentRendered event. (Inherited from Window .) |
...
|  | OnCreateAutomationPeer | Creates and returns a WindowAutomationPeer object for this Window . (Inherited from Window .) |
|  | OnDeactivated | Raises the Deactivated event. (Inherited from Window .) |
|  | OnDpiChanged | Called when the DPI at which this window is rendered changes. (Inherited from Window .) |
...
|  | OnLocationChanged | Raises the LocationChanged event. (Inherited from Window .) |
...
|  | OnManipulationBoundaryFeedback | Called when the ManipulationBoundaryFeedback event occurs. (Inherited from Window .) |
...
|  | OnSourceInitialized | Raises the SourceInitialized event. (Inherited from Window .) |
|  | OnStateChanged | Raises the StateChanged event. (Inherited from Window .) |
...
|  | OnVisualChildrenChanged | Called when the VisualCollection of this Window object is modified. (Inherited from Window .) |
|  | OnVisualParentChanged | Called when the parent of the window is changed. (Inherited from Window .) |
...
|  | ResetStoredFocus | (Inherited from MetroWindow .) |
...
|  | Show | Opens a window and returns without waiting for the newly opened window to close. (Inherited from Window .) |
|  | ShowDialog | Opens a window and returns only when the newly opened window is closed. (Inherited from Window .) |
|  | ShowOverlay | (Inherited from MetroWindow .) |
|  | ShowOverlayAsync | (Inherited from MetroWindow .) |
|  | StoreFocus | (Inherited from MetroWindow .) |
...
|  | Name | Description |
| --- | --- | --- |
|  | Activated | Occurs when a window becomes the foreground window. (Inherited from Window .) |
|  | Closed | Occurs when the window is about to close. (Inherited from Window .) |
|  | Closing | Occurs directly after Close is called, and can be handled to cancel window closure. (Inherited from Window .) |
|  | ContentRendered | Occurs after a window's content has been rendered. (Inherited from Window .) |
...
|  | Deactivated | Occurs when a window becomes a background window. (Inherited from Window .) |
|  | DpiChanged | Occurs after the DPI of the screen on which the Window is displayed changes. (Inherited from Window .) |
...
|  | FlyoutsStatusChanged | (Inherited from MetroWindow .) |
...
|  | LocationChanged | Occurs when the window's location changes. (Inherited from Window .) |
...
|  | SourceInitialized | This event is raised to support interoperation with Win32. See HwndSource . (Inherited from Window .) |
...
|  | StateChanged | Occurs when the window's WindowState property changes. (Inherited from Window .) |
...
|  | WindowTransitionCompleted | (Inherited from MetroWindow .) |

## Дочерние разделы
- [**NewSettingsWindow Constructor **](./NewSettingsWindow Constructor/README.md)
- [**NewSettingsWindow Properties**](./NewSettingsWindow Properties/README.md)
- [**NewSettingsWindow Methods**](./NewSettingsWindow Methods/README.md)
- [**NewSettingsWindow Events**](./NewSettingsWindow Events/README.md)
