# PremiumContentManagerGui Class
...
```csharp
public class PremiumContentManagerGui : UserControl , IComponentConnector
```
...
```csharp
public ref class PremiumContentManagerGui : public UserControl , IComponentConnector
```
...
The PremiumContentManagerGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | PremiumContentManagerGui | Initializes a new instance of the PremiumContentManagerGui class |
...
## Дочерние разделы
- [**PremiumContentManagerGui Constructor **](./PremiumContentManagerGui Constructor/README.md)
- [**PremiumContentManagerGui Properties**](./PremiumContentManagerGui Properties/README.md)
- [**PremiumContentManagerGui Methods**](./PremiumContentManagerGui Methods/README.md)
- [**PremiumContentManagerGui Events**](./PremiumContentManagerGui Events/README.md)
