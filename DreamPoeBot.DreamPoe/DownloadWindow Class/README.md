...
```csharp
public class DownloadWindow : UserControl , IComponentConnector
```
...
```csharp
public ref class DownloadWindow : public UserControl , IComponentConnector
```
...
The DownloadWindow type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | DownloadWindow | Initializes a new instance of the DownloadWindow class |
...
## Дочерние разделы
- [**DownloadWindow Constructor **](./DownloadWindow Constructor/README.md)
- [**DownloadWindow Properties**](./DownloadWindow Properties/README.md)
- [**DownloadWindow Methods**](./DownloadWindow Methods/README.md)
- [**DownloadWindow Events**](./DownloadWindow Events/README.md)
