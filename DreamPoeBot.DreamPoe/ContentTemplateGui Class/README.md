...
```csharp
public class ContentTemplateGui : UserControl , IComponentConnector
```
...
```csharp
public ref class ContentTemplateGui : public UserControl , IComponentConnector
```
...
The ContentTemplateGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | ContentTemplateGui | Initializes a new instance of the ContentTemplateGui class |
...
## Дочерние разделы
- [**ContentTemplateGui Constructor **](./ContentTemplateGui Constructor/README.md)
- [**ContentTemplateGui Properties**](./ContentTemplateGui Properties/README.md)
- [**ContentTemplateGui Methods**](./ContentTemplateGui Methods/README.md)
- [**ContentTemplateGui Events**](./ContentTemplateGui Events/README.md)
