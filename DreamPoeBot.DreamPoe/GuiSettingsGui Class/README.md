...
```csharp
public class GuiSettingsGui : UserControl , IComponentConnector
```
...
```csharp
public ref class GuiSettingsGui : public UserControl , IComponentConnector
```
...
The GuiSettingsGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | GuiSettingsGui | Initializes a new instance of the GuiSettingsGui class |
...
## Дочерние разделы
- [**GuiSettingsGui Constructor **](./GuiSettingsGui Constructor/README.md)
- [**GuiSettingsGui Properties**](./GuiSettingsGui Properties/README.md)
- [**GuiSettingsGui Methods**](./GuiSettingsGui Methods/README.md)
- [**GuiSettingsGui Events**](./GuiSettingsGui Events/README.md)
