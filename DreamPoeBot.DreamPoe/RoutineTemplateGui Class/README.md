...
```csharp
public class RoutineTemplateGui : UserControl , IComponentConnector
```
...
```csharp
public ref class RoutineTemplateGui : public UserControl , IComponentConnector
```
...
The RoutineTemplateGui type exposes the following members.


|  | Name | Description |
| --- | --- | --- |
|  | RoutineTemplateGui | Initializes a new instance of the RoutineTemplateGui class |
...
## Дочерние разделы
- [**RoutineTemplateGui Constructor **](./RoutineTemplateGui Constructor/README.md)
- [**RoutineTemplateGui Properties**](./RoutineTemplateGui Properties/README.md)
- [**RoutineTemplateGui Methods**](./RoutineTemplateGui Methods/README.md)
- [**RoutineTemplateGui Events**](./RoutineTemplateGui Events/README.md)
