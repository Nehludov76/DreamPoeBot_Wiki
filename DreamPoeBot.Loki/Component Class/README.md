...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Component"]
...
```csharp
public ref class Component abstract : public RemoteMemoryObject
```
...
|  | Name | Description |
| --- | --- | --- |
|  | Component | Initializes a new instance of the Component class |
...
## Дочерние разделы
- [**Component Constructor **](./Component Constructor/README.md)
- [**Component Properties**](./Component Properties/README.md)
- [**Component Methods**](./Component Methods/README.md)
- [**Component Fields**](./Component Fields/README.md)
