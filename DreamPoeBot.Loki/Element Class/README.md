...
```csharp
public ref class Element : public RemoteMemoryObject
```
...
## Дочерние разделы
- [**Element Constructor **](./Element Constructor/README.md)
- [**Element Properties**](./Element Properties/README.md)
- [**Element Methods**](./Element Methods/README.md)
- [**Element Fields**](./Element Fields/README.md)
