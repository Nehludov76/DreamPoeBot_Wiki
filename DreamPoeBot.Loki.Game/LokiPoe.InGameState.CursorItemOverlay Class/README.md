# LokiPoe.InGameState.CursorItemOverlay Class
...
```csharp
public static class CursorItemOverlay
```
...
```csharp
public ref class CursorItemOverlay abstract sealed
```
...
## Дочерние разделы
- [**CursorItemOverlay Properties**](./CursorItemOverlay Properties/README.md)
