# LokiPoe.InGameState.GuildStashUi.FragmentTab.Scarab Class

**Вложено элементов:** 110  
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.LokiPoe.InGameState.GuildStashUi.FragmentTab.Scarab"]
...
```csharp
public ref class Scarab abstract sealed
```
...
## Дочерние разделы
- [**Scarab Properties**](./Scarab Properties/README.md)
- [**Scarab Methods**](./Scarab Methods/README.md)
