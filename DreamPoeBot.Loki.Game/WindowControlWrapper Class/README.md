...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.WindowControlWrapper"]
...
```csharp
public ref class WindowControlWrapper : public RemoteMemoryObject
```
...
## Дочерние разделы
- [**WindowControlWrapper Properties**](./WindowControlWrapper Properties/README.md)
- [**WindowControlWrapper Methods**](./WindowControlWrapper Methods/README.md)
- [**WindowControlWrapper Fields**](./WindowControlWrapper Fields/README.md)
