# LokiPoe.InGameState.AtlasUi.MapDevice.Influence Class
...
```csharp
public ref class Influence abstract sealed
```
...
The LokiPoe InGameState AtlasUi MapDevice Influence type exposes the following members.
