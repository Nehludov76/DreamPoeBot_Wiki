...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.LokiPoe.InGameState.SentinelSkillUi.StalkerSentinel"]


```csharp
public static class StalkerSentinel
```
...
```csharp
public ref class StalkerSentinel abstract sealed
```
