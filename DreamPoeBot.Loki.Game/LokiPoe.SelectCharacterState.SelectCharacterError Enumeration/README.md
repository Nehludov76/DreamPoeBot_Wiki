...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.LokiPoe.SelectCharacterState.SelectCharacterError"]


```csharp
public enum SelectCharacterError
```
...
```csharp
public enum class SelectCharacterError
```
