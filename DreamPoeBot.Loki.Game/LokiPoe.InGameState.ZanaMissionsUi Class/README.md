...
```csharp
[ ObsoleteAttribute ("Not in game anymore, pls use KiracMissionsUi", false )] public static class ZanaMissionsUi
```
...
```csharp
[ ObsoleteAttribute (L"Not in game anymore, pls use KiracMissionsUi", false )] public ref class ZanaMissionsUi abstract sealed
```
