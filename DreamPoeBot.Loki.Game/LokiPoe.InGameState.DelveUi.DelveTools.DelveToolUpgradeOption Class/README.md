...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.LokiPoe.InGameState.DelveUi.DelveTools.DelveToolUpgradeOption"]


```csharp
public class DelveToolUpgradeOption
```
...
```csharp
public ref class DelveToolUpgradeOption
```
