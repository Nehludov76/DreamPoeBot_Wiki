# LokiPoe.InGameState.StashUi.DelveTab Class
...
[Missing <summary> documentation for "T:DreamPoeBot.Loki.Game.LokiPoe.InGameState.StashUi.DelveTab"]


```csharp
public static class DelveTab
```
...
```csharp
public ref class DelveTab abstract sealed
```
